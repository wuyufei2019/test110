 ...
 * 安全管理-吊装安全作业dao层
 */
@Repository("ztAqglDzaqzyDao")
public class AqglDzaqzyDao extends BaseDao<ZTAQGL_Dzaqzy, Long> {
	...
	public List<Map<String, Object>> dataGrid(Map<String, Object> mapData) {
		...
		String sql =" SELECT top "+mapData.get("pageSize")+" * FROM ( SELECT ROW_NUMBER() OVER ("+ordercont+") AS RowNumber,a.*,b.m1 qyname,c.name sqr,dep.m1 depname FROM ztaqgl_dzaqzy a "
				+ " left join bis_enterprise b on a.id1=b.id "
				+ " left join t_user c on a.m20_1=c.id "
	...
	public int getTotalCount(Map<String,Object> mapData) {
		String content = content(mapData);
		String queryString = "select count(*) from ztaqgl_dzaqzy a " 
							+ " left join bis_enterprise b on a.id1=b.id "
							+ " left join t_user c on a.m20_1=c.id "
							+ " left join t_department dep on c.departmen = dep.id "				
							+ " WHERE a.S3=0 and b.S3=0 "+content;
	...
	public Map<String, Object> findInforById(Long id) {
		String sql="SELECT a.*,b.m1 qyname,c.name bzr FROM ztaqgl_dzaqzy a"
				+ " left join bis_enterprise b on a.id1=b.id "
				+ " left join t_user c on a.m20_1=c.id "
    ...
    public void deleteInfo(Long id) {
		String sql=" UPDATE ztaqgl_dzaqzy SET S3=1 WHERE ID="+id;
		updateBySql(sql);
	}
	...
	public String content(Map<String,Object> mapData) {
		...
		if (mapData.get("m7") != null && mapData.get("m7") != "") {
			content += " and a.m7='" + mapData.get("m7")+"' ";
		}
		if (mapData.get("zt") != null && mapData.get("zt") != "") {
			content += " and a.zt='" + mapData.get("zt")+"' ";
		}
		if (mapData.get("dspzt") != null && mapData.get("dspzt") != "") {
			content += " and '"+mapData.get("dspzt")+"' like '%,'+a.zt+',%' and ((a.m7='一级吊装' and datediff(hour, isnull(a.m20_7, GETDATE()),GETDATE())<=24) or (a.m7!='一级吊装' and datediff(hour, isnull(a.m20_7, GETDATE()),GETDATE())<=(3*24))) ";
		}
	...
	public List<Map<String, Object>> aqcsList(Map<String, Object> mapData) {
		String sql  ="SELECT top  "+mapData.get("pageSize")+" * FROM ("
				+ "SELECT ROW_NUMBER() OVER (ORDER BY a.id) AS RowNumber,a.* FROM ztaqgl_saftymeasure a where a.m2=5"
	...
	public int aqcsCount() {
		String  sql= "select count(*) from ztaqgl_saftymeasure a WHERE a.m2=5 ";
	...
	public Map<String,Object> findallById(long id) {
		String sql = " SELECT a.*, c.NAME bzcsr, dep.m1 depname FROM ztaqgl_dzaqzy a "
				+ " left join t_user c on c.id=a.m20_1 "
				+ " left join t_department dep on c.departmen = dep.id "
				+ " WHERE a.id=" + id;
		List<Map<String,Object>> list = findBySql(sql, null, Map.class);
		return list.get(0);
    ...
    public List<Map<String, Object>> getExport(Map<String, Object> mapData) {
		...
		String sql="SELECT a.id,convert(varchar(19),a.s1,120) s1,a.s2,a.s3,a.id1,a.id2,a.m1,a.m2,a.m3,a.m4,a.m5,convert(varchar(19),a.m6,120) m6,convert(varchar(19),a.m7,120) m7,a.m8,a.m9,a.m10,a.m11,a.m12,a.m13,a.m13_1,a.m14,a.m15,a.m15_1,a.m16,a.m16_1,a.m17"
				...
				+ " FROM t_user z WHERE PATINDEX('%,' + RTRIM(z.ID) + ',%',',' + a.m14 + ',')>0 ORDER BY PATINDEX('%,' + RTRIM(z.ID) + ',%', ',' + a.m14 + ',') FOR XML PATH('')), 1, 1, '') as varchar(200)) fxr FROM ztaqgl_dzaqzy a LEFT JOIN t_user n ON n.ID = a.id2 LEFT JOIN t_user c ON c.ID = a.m27"
