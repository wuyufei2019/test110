 ...
 */
@Controller
@RequestMapping("fxgk/fxxx2")
public class PageFxgkfxxx2Controller extends BaseController {
		...
		if(sessionuser.getUsertype().equals("1")){//企业用户
			...
			if(be!=null&&be.getM1()!=null){//判断是否添加了企业基本信息
				if(be.getIsbloc()!=null&&be.getIsbloc()==1)//判断是否为集团公司
					return "fxgk/fxdxx2/index";
				else
					return "fxgk/fxdxx2/qyindex";
	...
	public Map<String, Object> ajgetData(HttpServletRequest request) {
        ...
        map.put("fc", request.getParameter("fxgk_fxxx_fc"));
		map.put("depid", request.getParameter("fxgk_fxxx_depid"));
	...
	public String viewka(@PathVariable("id") Long id, Model model,
		...
		if("A2".equals(type)){
			...
			WordUtil.ireportWord(map, "sgfx2A2.ftl", dowmloadPath, filename, request);
			...
			WordUtil.ireportWord(map, "sgfx2A3.ftl", dowmloadPath, filename, request);
		}
		return filename;
	}
	/**
	...
	public String expiExcel(HttpServletResponse response, HttpServletRequest request) {
		...
		if (map.get("content") != null) {
			...
			resultmap = sxgkfxxxService.exinExcel2(map);
		} else {
