 ...
 */
@Controller
@RequestMapping("sekb/aqscgz")
public class PageSekbAqscgzController extends BaseController {
	 ...
	 * @param request
	 */
	@RequiresPermissions("sekb:aqscgz:view")
	...
	public Map<String, Object> getData(HttpServletRequest request) {
		...
		map.put("type", "3");//规章
		map.put("btname", request.getParameter("sekb_aqscgz_bt_name"));
	 ...
	 * @param model
	 */
	@RequiresPermissions("sekb:aqscgz:add")
	@RequestMapping(value = "create", method = RequestMethod.GET)
	public String create(Model model) {
		model.addAttribute("action", "create");
		model.addAttribute("usertype",UserUtil.getCurrentShiroUser().getUsertype());
		return "sekb/aqscgz/form";
	}
	 ...
	 * @param id,model
	 */
	@RequiresPermissions("sekb:aqscgz:update")
	 ...
	 */
	@RequiresPermissions("sekb:aqscgz:delete")
	 ...
	 * 
	 */
	@RequiresPermissions("sekb:aqscgz:excel")
	...
	public String getWord(@PathVariable("id") Long id,HttpServletRequest request, HttpServletResponse response) {
		...
		WordUtil.ireportWord(map, "aqgz.ftl", filePath, filename, request);
