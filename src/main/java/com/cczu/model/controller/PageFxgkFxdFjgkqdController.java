 ...
 */
@Controller
@RequestMapping("fxgk/fxdfjgkqd")
public class PageFxgkFxdFjgkqdController extends BaseController {
		...
		if(sessionuser.getUsertype().equals("1")){//企业用户
			...
			if(be!=null&&be.getM1()!=null){//判断是否添加了企业基本信息
				if(be.getIsbloc()!=null&&be.getIsbloc()==1)//判断是否为集团公司
					return "fxgk/fxdfjgkqd/index";
				else
					return "fxgk/fxdfjgkqd/qyindex";
	...
	public Map<String, Object> ajgetData(HttpServletRequest request) {
		...
		map.put("name", request.getParameter("fxgk_fxdfjgkqd_name"));
		map.put("fxlb", request.getParameter("fxgk_fxdfjgkqd_fxlb"));
		map.put("fxfj", request.getParameter("fxgk_fxdfjgkqd_fxfj"));
		map.put("sglx", request.getParameter("fxgk_fxdfjgkqd_sglx"));
		map.put("ewm", request.getParameter("fxgk_fxdfjgkqd_ewm"));
		map.put("xiangzhen", request.getParameter("fxgk_fxdfjgkqd_xz"));
		map.put("wgxzqy", request.getParameter("fxgk_fxdfjgkqd_xzqy"));
		map.put("qyname", request.getParameter("fxgk_fxdfjgkqd_qyname"));
	 ...
	 *  ,model
	 */
	@RequiresPermissions("fxgk:fxdfjgkqd:view")
	...
	public String homeIndex(Model model) {
		...
		return "fxgk/fxdfjgkqd/homeindex";
	}
