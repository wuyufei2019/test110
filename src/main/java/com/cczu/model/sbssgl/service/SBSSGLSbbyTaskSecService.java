...
/**
 * 设备设施管理-设备二级保养任务Service
 *
 */
@Service("SBSSGLSbbyTaskSecService")
public class SBSSGLSbbyTaskSecService {
	...
	public Map<String,Object> findPageMapByMap(Map<String, Object> mapData) {
		List<Map<String,Object>> list=sBSSGLSbbyTaskSecDao.findPageListByMap(mapData);
		int getTotalCount=sBSSGLSbbyTaskSecDao.getPageTotalCountByMap(mapData);
	 ...
	 * @param entity
	 */
	public void addInfo(SBSSGL_SBBYTASKSECEntity entity) {
		Timestamp t=DateUtils.getSysTimestamp();
		entity.setS1(t);
		entity.setS2(t);
		entity.setS3(0);
		sBSSGLSbbyTaskSecDao.save(entity);
	}
	 ...
	 * @param entity
	 */
	public void updateInfo(SBSSGL_SBBYTASKSECEntity entity) {
		Timestamp t=DateUtils.getSysTimestamp();
		entity.setS2(t);
		sBSSGLSbbyTaskSecDao.save(entity);
	}
	...
	public void deleteInfoById(Long id) {
		sBSSGLSbbyTaskSecDao.deleteInfo(id);
	}
	...
	public void deleteInfoByTaskid(Long taskid) {
		sBSSGLSbbyTaskSecDao.deleteInfoByTaskid(taskid);
	}
	...
	public List<Map<String,Object>> findListByMap(Map<String, Object> mapData) {
		return sBSSGLSbbyTaskSecDao.findListByMap(mapData);
	}
	
	public SBSSGL_SBBYTASKSECEntity find(Long id) {
		return sBSSGLSbbyTaskSecDao.find(id);
	}
	...
	public void exportExcel(HttpServletResponse response, Map<String, Object> mapData, HttpServletRequest request) {
		...
		String fileName= year + "年设备二级保养计划表.xls";
		String title = year + "年设备二级保养计划表";
		Map<String, Object> dataMap = new HashMap<>();
		List<Map<String, Object>> list=sBSSGLSbbyTaskSecDao.getExport(mapData);
		dataMap.put("list", list);
		dataMap.put("title", title);
		String tempPath = request.getSession().getServletContext().getRealPath("/")+"/WEB-INF/templates/二级保养计划模板.xls";
       ...
       if (list != null && list.size() > 0) { 
           ...
           for (Map<String, String> map : list) {  
               ...
               //循环输出map中的子集：既列值  
            	   ...
            	   sheet.addCell(new Label(16,i,String.valueOf(map.get("deptname")),wcf_left));
            	   i++;
           }  
       }
		   workbook.write();  
	...
	public List<Map<String, Object>> getFileList(Map<String, Object> mapData) {
		 return sBSSGLSbbyTaskSecDao.getFileList(mapData);
	}
}
