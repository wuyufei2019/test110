 ...
 */
@Entity
@Table(name="issue_govermentfilerelease")
public class ISSUE_GovermentFileReleaseEntity extends BaseEntity {
	...
	@Column(name = "ZFIDS", nullable = true,columnDefinition="varchar(max)")
	@Setter
	@Getter	
	private String zfids;//政府人员id
