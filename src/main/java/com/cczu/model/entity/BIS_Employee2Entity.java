 ...
 */
@Entity
@Table(name="bis_employee_second")
public class BIS_Employee2Entity extends BaseEntity {
	...
	public BIS_Employee2Entity() {
	}

	public BIS_Employee2Entity(Long id) {
		this.ID=id;
	}
	
	public BIS_Employee2Entity(String m1, String m2, String m3, String m4,
	...
	public BIS_Employee2Entity(Long ID1,String ID2,Long ID3,Long ID4,String m1, String m3,
