...
/**
 * 
 * @ClassName: ISSUE_ZfFileTransmissionReceivingEntity
 * @Description: 政府安全文件发布_文件传递与接收
 * @author jason
 * @date 2017年5月27日
 *
 */
@Entity
@Table(name="issue_zffiletransmissionreceiving")
public class ISSUE_ZfFileTransmissionReceivingEntity extends BaseEntity {
