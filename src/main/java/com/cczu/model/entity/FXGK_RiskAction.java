...
@Entity
@Table(name="fxgk_riskaction")
public class FXGK_RiskAction implements Serializable{
	...
	@Column(name = "workstep", nullable = true, columnDefinition="varchar(500)")
	@Setter
	@Getter
	private String workstep;//工作步骤
