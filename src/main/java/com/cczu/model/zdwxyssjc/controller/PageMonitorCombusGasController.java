...
/**
 * 在线监控预警-可燃气体传感器数据controller
 * @author jason
 * @date 2017年6月23日
 */
@Controller
@RequestMapping("zxjkyj/krqtcgq")
public class PageMonitorCombusGasController extends BaseController {
	...
	public String index(Model model) {
		...
		return "zxjkyj/ssjc/krqtcgq/index";
	}
	...
	public Map<String, Object> getData(HttpServletRequest request) {
		...
		map.put("qyname", request.getParameter("ssjc_krqtcgq_qy_name"));
		map.putAll(getAuthorityMap());
		return monitorCombusGasService.dataGrid(map);
	}
	...
	public String selectQyJson(Model model,HttpServletRequest request) {
		return monitorCombusGasService.qyListJson(getAuthorityMap());
	}
	...
	public Map<String, Object> list(HttpServletRequest request) {
		...
		List<Map<String,Object>> list=monitorCombusGasService.findMapList(mapdata);
	...
	public void export(String ids, HttpServletResponse response) {
		...
		monitorCombusGasService.exportExcel(response, map);
	...
	public String view(@PathVariable("id") Long id, Model model) {
		List<Map<String, Object>> cllist=monitorCombusGasService.findInfoByQyid(id);
		BIS_EnterpriseEntity ent= qyjbxxService.findInfoById(id);
		model.addAttribute("cllist", cllist);
		model.addAttribute("qiye", ent);
		return "zxjkyj/ssjc/krqtcgq/view";
	}
}
