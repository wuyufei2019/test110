...
/**
 * 在线监控预警-液位传感器数据controller
 * @author jason
 * @date 2017年6月23日
 */
@Controller
@RequestMapping("zxjkyj/ywcgq")
public class PageMonitorLiquidLevelController extends BaseController {
	...
	public String index(Model model) {
		...
		return "zxjkyj/ssjc/ywcgq/index";
	}
	...
	public Map<String, Object> getData(HttpServletRequest request) {
		...
		map.put("qyname", request.getParameter("ssjc_ywcgq_qy_name"));
		map.putAll(getAuthorityMap());
		return monitorLiquidLevelService.dataGrid(map);
	}
	...
	public String selectQyJson(Model model,HttpServletRequest request) {
		return monitorLiquidLevelService.qyListJson(getAuthorityMap());
	}
	...
	public Map<String, Object> list(HttpServletRequest request) {
		...
		List<Map<String,Object>> list=monitorLiquidLevelService.findMapList(mapdata);
	...
	public void export(String ids, HttpServletResponse response) {
		...
		monitorLiquidLevelService.exportExcel(response, map);
	...
	public String view(@PathVariable("id") Long id, Model model) {
		List<Map<String, Object>> cllist=monitorLiquidLevelService.findInfoByQyid(id);
		BIS_EnterpriseEntity ent= qyjbxxService.findInfoById(id);
		model.addAttribute("cllist", cllist);
		model.addAttribute("qiye", ent);
		return "zxjkyj/ssjc/ywcgq/view";
	} 
}
