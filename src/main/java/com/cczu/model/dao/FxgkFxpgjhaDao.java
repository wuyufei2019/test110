...
@Repository("FxgkFxpgjhaDao")
public class FxgkFxpgjhaDao extends BaseDao<FXGK_RiskAssessment, Long> {
	...
	public List<Map<String,Object>> dataGrid(Map<String, Object> mapData) {
		...
		String sql = " SELECT top " + mapData.get("pageSize") 
				    ...
				    + " fxgk_riskassessment a left join bis_jobpostentity job on job.id=a.jobid"
	...
	public int getTotalCount(Map<String, Object> mapData) {
		String sql = " SELECT COUNT(1) sum  FROM FXGK_RiskAssessment a left join bis_jobpostentity job on job.id=a.jobid"
	...
	public void deleteInfo(Long id) {
		String sql = " UPDATE FXGK_RiskAssessment SET S3=1 WHERE ID=" + id;
		updateBySql(sql);
	}
	
	public Map<String,Object> export(long id) {
		String sql = " SELECT a.*,job.m1 jobname,dept.m1 deptname from fxgk_riskassessment a left join bis_jobpostentity job on job.id=a.jobid"
