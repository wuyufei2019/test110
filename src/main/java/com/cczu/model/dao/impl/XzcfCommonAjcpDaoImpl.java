...
import com.cczu.model.dao.IZxcfCommonAjcpDao;
...
public class XzcfCommonAjcpDaoImpl extends BaseDao<XZCF_YbcfAjcpEntity, Long>
	...
	public List<Map<String,Object>> dataGrid(Map<String, Object> mapData) {
		...
		String sql = " SELECT TOP "+ mapData.get("pageSize")
				+ " * FROM ( SELECT ROW_NUMBER() OVER (ORDER BY a.ID DESC)  AS RowNumber,a.id,a.number,a.casename,a.illegalactandevidence from xzcf_ybcfajcp a"
