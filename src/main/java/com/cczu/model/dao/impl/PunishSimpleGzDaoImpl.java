...
import com.cczu.model.dao.IPunishSimpleGzDao;
...
public class PunishSimpleGzDaoImpl extends BaseDao<XZCF_GzsInfoEntity, Long>
	...
	public List<Map<String, Object>> dataGrid(Map<String, Object> mapData) {
		...
		String sql = " SELECT TOP "+ mapData.get("pageSize")
				+ " * FROM ( SELECT ROW_NUMBER() OVER (ORDER BY a.ID DESC)  AS RowNumber,a.id,a.number,a.name,a.punishdate,a.illegalact,a.unlaw from xzcf_gz a "
