...
public class XzcfCommonSxcgDao extends BaseDao<XZCF_YbcfSxcgEntity, Long> {
	...
	public List<Map<String, Object>> dataGrid(Map<String, Object> mapData) {
		...
		String sql = " SELECT TOP "+ mapData.get("pageSize")
				+ " * FROM ( SELECT ROW_NUMBER() OVER (ORDER BY a.ID DESC)  AS RowNumber,a.id,a.number,a.qyname,a.xzjd,a.s1,b.qzflag,b.jaflag from xzcf_ybcfsxcg a "
	...
	public String content(Map<String, Object> mapData) {
		...
		if (mapData.get("type") != null && mapData.get("type") != "") {
			if("1".equals(mapData.get("type"))){
				content+=" and b.jaflag !=1 and b.qzflag!=1 and DATEDIFF (day,a.s1,getDate())>50";
			}else
				content+=" AND (b.jaflag =1 or b.qzflag=1 or DATEDIFF (day,a.s1,getDate())<=50)";
		}
