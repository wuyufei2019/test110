...
@Repository("ErmYjczfaDao")
public class ErmYjczfaDao extends BaseDao<ERM_EmergencyDisposalPlan, Long> {
    ...
    public int getTotalCount(Map<String, Object> mapData) {
        String sql = " SELECT COUNT(1) sum  FROM erm_emergencydisposalplan a "
    ...
    public void deleteInfo(Long id) {
        String sql = " UPDATE erm_emergencydisposalplan SET S3=1 WHERE ID=" + id;
        updateBySql(sql);
    }

    public Map<String,Object> export(long id) {
        String sql = " SELECT a.*,bis.m1 qyname from erm_emergencydisposalplan a left join bis_enterprise bis ON bis.id = a.ID1 "
