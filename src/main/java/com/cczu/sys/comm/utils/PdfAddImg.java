...
public class PdfAddImg {
	...
	private static class PdfRenderListener implements RenderListener {
		...
		Rectangle.Float rectangle = textRenderInfo.getAscentLine().getBoundingRectange();
	...
	public static void main(String[] args) throws Exception {
		File pdfFile = new File("D:\\test\\aaa.pdf");
		...
		// 模板文件路径
	    String templatePath = "D:\\test\\aaa.pdf";
	    // 生成的文件路径
	    String targetPath = "D:\\test\\a.pdf";
	    // 图片路径
	    String imagePath = "D:\\test\\Shimano_logo.png";
		...
		if (positions != null && positions.size() > 0) {
			for (float[] position : positions) {
			    ...
			    // 添加图片(左距，下距)
			    image.setAbsolutePosition(width*(float)(position[1]+0.09), height*(float)(1-position[2]-0.015));
