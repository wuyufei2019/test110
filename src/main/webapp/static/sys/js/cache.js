...
layui.use(['form','jquery',"layer"],function() {
    ...
    function showNotice(){
        ...
        layer.open({
            ...
            btn: ['去看看'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">公告名称</p></pclass></p><p>公告内容</span></p></div>',
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            ...
                            '<div class="admin-header-lock-name" id="lockUserName">中安华鼎开发部</div>'+
                            '<div class="input_btn">'+
