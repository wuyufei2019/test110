...
$(function(){
    ...
    columns:[[    
		...
		{field:'m22',title:'所属储罐区',sortable:false,width:100},
		{field:'m1',title:'储罐名称',sortable:false,width:100},
        {field:'m9',title:'储罐编号',sortable:false,width:100,align:'center'},   
	...
	onLoadSuccess: function() {
		$(this).datagrid('autoMergeCells', ['m22']);
	},
	checkOnSelect:false,
	selectOnCheck:false,
    toolbar:'#bis_cgxx_tb'
...
//弹窗增加
function add(u) {
	openDialog("添加储罐信息",ctx+"/bis/cgxx/create/","800px", "600px","");
}
...
function upd(){
	...
	openDialog("修改储罐信息",ctx+"/bis/cgxx/update/"+row.id,"800px", "600px","");
...
function view(){
	...
	openDialogView("查看储罐信息",ctx+"/bis/cgxx/view/"+row.ID,"800px", "600px","");
