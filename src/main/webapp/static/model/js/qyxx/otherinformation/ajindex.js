...
$(function(){
	...
	method: "post",
    url:ctx+'/bis/otherinformation/ajlist', 
    fit : true,
	fitColumns : true,
	border : false,
	idField : 'ID',
...
//弹窗增加
function add(u) {
	openDialog("添加储罐信息",ctx+"/bis/otherinformation/create/","800px", "400px","");
}
...
function upd(){
	...
	openDialog("修改储罐信息",ctx+"/bis/otherinformation/update/"+row.id,"800px", "400px","");
...
function view(){
	...
	openDialogView("查看储罐信息",ctx+"/bis/otherinformation/view/"+row.id,"800px", "400px","");
	
}

//创建查询对象并查询
function search(){
	$('#bis_otherinformation_cx_qyname').combobox('setValue',$('#bis_otherinformation_cx_qyname').combobox('getText'));
