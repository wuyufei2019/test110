...
$(function(){
	...
	method: "post",
    url:ctx+'/bis/fieldsupply/ajlist',
    fit : true,
	fitColumns : true,
	border : false,
	idField : 'id',
...
//弹窗增加
function add(u) {
	openDialog("添加现场供气信息",ctx+"/bis/fieldsupply/create/","800px", "400px","");
}
...
function upd(){
	...
	openDialog("修改现场供气信息",ctx+"/bis/fieldsupply/update/"+row.id,"800px", "400px","");
...
function view(){
	...
	openDialogView("查看现场供气信息",ctx+"/bis/fieldsupply/view/"+row.id,"800px", "400px","");
	
}

//创建查询对象并查询
function search(){
	$('#bis_fieldsupply_cx_qyname').combobox('setValue',$('#bis_fieldsupply_cx_qyname').combobox('getText'));
