...
$(function(){
	dg1=$('#bjyj_qtxx_dg').datagrid({    
		nowrap:false,
		method: "post",
	    url:ctx+'/fmew/bj/qtlist',
	    fit : true,
		fitColumns : true,
		selectOnCheck:false,
		nowrap: false,
...
//处理情况查询
function search(){
	var obj=$("#bjyj_qtxx_searchFrom").serializeObject();
	$('#bjyj_qtxx_dg').datagrid('load',obj); 
}

//清空
function clearA(){
	$("#bjyj_qtxx_searchFrom").form("clear");
	var obj=$("#bjyj_qtxx_searchFrom").serializeObject();
	$('#bjyj_qtxx_dg').datagrid('load',obj);
}
...
//学习记录datagrid
$(function(){   
	dg2=$('#bjyj_qtxx_dg2').datagrid({    
		nowrap:false,
		method: "post",
	    url:ctx+'/fmew/bj/qtlist2',
	    fit : true,
		fitColumns : true,
		selectOnCheck:false,
		nowrap: false,
...
//学习记录查询
function search2(){
	var obj=$("#bjyj_qtxx_searchFrom2").serializeObject();
	$('#bjyj_qtxx_dg2').datagrid('load',obj); 
}

//清空
function clearA2(){
	$("#bjyj_qtxx_searchFrom2").form("clear");
	var obj=$("#bjyj_qtxx_searchFrom2").serializeObject();
	$('#bjyj_qtxx_dg2').datagrid('load',obj);
}
...
function view(){
	...
	openDialogView("查看浓度报警信息",ctx+"/fmew/bj/view/"+row.id,"800px", "400px","");
...
function fileexport1(){
	$("#status").val(0);
	window.expara=$("#bjyj_qtxx_searchFrom").serializeObject();
	window.exdata=[
...
function fileexport2(){
	$("#status2").val(1);
	var ss=$("#status").val();
	window.expara=$("#bjyj_qtxx_searchFrom2").serializeObject();
	window.exdata=[
			   		{colval:'colltime', coltext:'报警时间'},
			   		{colval:'situation', coltext:'报警情况'},
			   		{colval:'reason', coltext:'报警原因'}
