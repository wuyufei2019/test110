...
$(function(){
	dg1=$('#bjyj_cgxx_dg').datagrid({    
		nowrap:false,
		method: "post",
	    url:ctx+'/fmew/bj/cglist',
	    fit : true,
		fitColumns : true,
		selectOnCheck:false,
		nowrap: false,
...
//学习记录datagrid
$(function(){   
	dg2=$('#bjyj_cgxx_dg2').datagrid({    
		nowrap:false,
		method: "post",
	    url:ctx+'/fmew/bj/cglist2',
	    fit : true,
		fitColumns : true,
		selectOnCheck:false,
		nowrap: false,
...
function view(){
	...
	openDialogView("查看储罐报警信息",ctx+"/fmew/bj/view/"+row.id,"800px", "400px","");
...
function fileexport1(){
	$("#status").val(0);
	window.expara=$("#bjyj_cgxx_searchFrom").serializeObject();
	window.exdata=[
...
function fileexport2(){
	$("#status2").val(1);
	window.expara=$("#bjyj_cgxx_searchFrom2").serializeObject();
	window.exdata=[
			   		{colval:'colltime', coltext:'报警时间'},
			   		{colval:'situation', coltext:'报警情况'},
			   		{colval:'reason', coltext:'报警原因'}
