...
function upd() {
	...
	openDialog("修改案件呈批记录", ctx + "/xzcf/ybcf/ajclcp/update/" + row.id, "800px","400px", "");
}
...
function view() {
	...
	openDialogView("案件记录信息查看",ctx + "/xzcf/ybcf/ajclcp/view/" + row.id, "800px","400px", "");
