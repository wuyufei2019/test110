...
var wtid=1;
$(function(){
	dg=$('#yhpc_rcjcjl_dg').datagrid({    
	method: "post",
    url:ctx+'/yhpc/rcjl/list', 
    fit : true,
	fitColumns : true,
	border : false,
	idField : 'id',
    ...
    columns:[[    
        ...
        {field:'taskname',title:'任务名称',sortable:false,width:80,align:'center'},
        {field:'jcr',title:'检查人',sortable:false,width:80,align:'center'},
        {field:'m1',title:'检查时间',sortable:false,width:80,align:'center',
        ...
        {field:'m4',title:'检查结果',sortable:false,width:80,align:'center',
			formatter : function(value, row, index) {
				var content="";
              	if(value!=null&&value!='') {
              		return "有隐患";
        ...
        {field:'m5',title:'问题备注',sortable:false,width:80,align:'center'},
		{field:'m3',title : '现场照片',sortable : false,width : 60,align : 'center',
			formatter : function(value, row, index) {
				var content="";
              	if(value!=null&&value!='') {
...
//添加初查信息
function add(u) {
	openDialog("添加检查记录信息",ctx+"/yhpc/lsjcjl/create/","800px", "465px","");
}

//修改初查信息
function upd(id){
	openDialog("修改检查记录信息",ctx+"/yhpc/lsjcjl/updatecc/"+id,"800px", "400px","");
...
function view(){
	...
	openDialogView("查看检查记录信息",ctx+"/yhpc/rcjl/view/"+row.id,"95%", "95%","");
}
