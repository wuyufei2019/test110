...
<script type="text/javascript">
	...
	uploader.on( 'uploadSuccess', function( file ,gczy) {
		...
		if(gczy.error==0){
			...
			var newurl=gczy.url+"||"+gczy.fileName;
			...
			layer.msg(gczy.message,{time: 3000});
		}
	});

	if('${action}' == 'updateSub'){
		var zpUrl = '${gczy.m16_1}';
		if(zpUrl!=null&&zpUrl!=''){
