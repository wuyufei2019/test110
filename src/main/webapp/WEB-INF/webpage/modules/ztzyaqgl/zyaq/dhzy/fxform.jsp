...
<body>
     <form id="inputForm" action="${ctx}/ztzyaqgl/dhzy/${action}"  method="post" class="form-horizontal" >
			...
			<table id="rwtable" style="width: 100%;"  border="1" cellspacing="0" cellpadding="0" bordercolor="#e7e7e7" >
				<tr >
					<td style="text-align: center;width: 20%;">分析点名称</td>
					<td style="text-align: center;width: 15%;">介质</td>
					<td style="text-align: center;width: 15%;">数值</td>
...
function addRw() {
	...
	var $li = $(
				...
				'<input type="text" id="name_'+rwid+'" name="name" class="easyui-textbox" value="" required="true" style="height: 30px;width: 99%;" />'+
				'</td>'+
				'<td style="" align="center">'+
				'<input type="text" id="media_'+rwid+'" name="media" class="easyui-textbox" value="" required="true" style="height: 30px;width: 99%;" />'+
				'</td>'+
				'<td style="" align="center">'+
				'<input type="text" id="number_'+rwid+'" name="number" class="easyui-textbox" value="" required="true" style="height: 30px;width: 99%;" />'+
				'</td>'+
				'<td style="" align="center">'+
				'<input type="text" id="unit_'+rwid+'" name="unit" class="easyui-textbox" value="" required="true" style="height: 30px;width: 99%;" />'+
				'</td>'+
				'<td style="" align="center">'+
				'<input type="text" id="person_'+rwid+'" name="person" class="easyui-textbox" value="'+username+'" required="true" style="height: 30px;width: auto;" />'+
				'</td>'+				
				'<td style="" align="center">'+
    	...
    	if(dhzy.error==0){
    		var $li = $(
    	            "<div id=\"" + file.id + "\" >" +
    	                ...
    	                "<a target='_blank' href='"+dhzy.url+"'><div class=\"info\">" + file.name + "</div></a>" +
    	            "</div>"
    	            ),
