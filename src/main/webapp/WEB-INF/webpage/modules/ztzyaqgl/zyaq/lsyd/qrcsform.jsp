			 ...
			 <tbody>
			  ...
			  <tr>
				  ...
				  <td class="width-80" colspan="3">
					  <div id="uploader_ws_m22_2">
				      <div id="m22_2fileList" class="uploader-list" ></div>
			   ...
			   <input type="hidden" name="lsid" value="${id1 }" />
			<tbody>
		</table>
     </form>
...
$(function(){ 
    ...
    //图片上传成功，显示预览图
    uploader3.on( 'uploadSuccess', function( file ,lsyd) {
    	$.jBox.closeTip();
...
uploader.on( 'uploadSuccess', function( file ,lsyd) {
	...
	if(lsyd.error==0){
		...
		$('#uploader_ws_m22_2').append( $input );
