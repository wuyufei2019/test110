			 ...
			 <tbody>
			  ...
			  <tr>
				  ...
				  <td class="width-80" colspan="3">
					  <div id="uploader_ws_m19_2">
				      <div id="m19_2fileList" class="uploader-list" ></div>
			   ...
			   <input type="hidden" name="dtid" value="${id1 }" />
			<tbody>
		</table>
     </form>
...
$(function(){ 
    ...
    //图片上传成功，显示预览图
    uploader3.on( 'uploadSuccess', function( file ,dtzy) {
    	$.jBox.closeTip();
...
uploader.on( 'uploadSuccess', function( file ,dtzy) {
	...
	if(dtzy.error==0){
		...
		$('#uploader_ws_m19_2').append( $input );
