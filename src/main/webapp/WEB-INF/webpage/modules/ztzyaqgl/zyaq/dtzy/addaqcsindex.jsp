...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/ztzyaqgl/zyaq/dtzy/aqcsindex.js?v=1.0"></script>
</head>
<body >
	...
	function doSubmit(){
		...
		if(type==0){
			...
			top.layer.confirm('是否添加安全措施？', {icon: 3, title:'提示'}, function(index){
				$.ajax({
					type:'get',
					url:ctx+"/ztzyaqgl/dtzy/createAqcs",
					data : {'list' : JSON.stringify(rs),'dtid' : id1, 'flag':'upd'},
