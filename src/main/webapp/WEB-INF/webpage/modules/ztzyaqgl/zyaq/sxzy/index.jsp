...
<html>
<head>
	<title>受限空间作业信息</title>
	<meta name="decorator" content="default"/>
	<script type="text/javascript" src="${ctx}/static/model/js/ztzyaqgl/zyaq/sxzy/index.js?v=1.9"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="zyaqgl_sxzy_tb" style="padding:5px;height:auto">
	<form id="searchFrom" action="" style="margin-bottom: 8px;" class="form-inline">				
	<div class="form-group">
		<shiro:hasPermission name="zyaqgl:gczy:viewall">
			<input name="aqgl_sxzy_cx_depid" class="easyui-combotree" style="height: 30px;" data-options="editable:false,panelHeight:180, valueField: 'id',textField: 'text',url:'${ctx}/system/department/idjson', prompt:'所属部门' "/>
		</shiro:hasPermission>
		<input type="text" id="aqgl_sxzy_cx_m1" name="aqgl_sxzy_cx_m1" class="easyui-textbox" style="height: 30px;" data-options="prompt: '作业证编号 '"/>
		<input class="easyui-combobox" name="aqgl_sxzy_cx_m13"  style="height: 30px;" data-options="panelHeight:'auto', prompt: '受限空间作业级别 ',editable:false ,data: [
																																		        {value:'一般',text:'一般'},
																																		        {value:'特殊',text:'特殊'}] "/>
		<input class="easyui-combobox" name="aqgl_sxzy_cx_zt"  style="height: 30px;" data-options="panelHeight:'150', prompt: '作业证状态 ',editable:false ,data: [
																																		        {value:'0',text:'待编制'},
																																		        {value:'1',text:'待作业单位签字'},
																																		        {value:'2',text:'待安技员签字'},
																																		        {value:'3',text:'待部门一把手签字'},
																																		        {value:'4',text:'待分厂安全分管领导或分管领导签字'},
	...
	<div class="col-sm-12">
		<div class="pull-left">
		<span id="divper">
			<shiro:hasPermission name="zyaqgl:sxzy:add">
			...
			<shiro:hasPermission name="zyaqgl:sxzy:delete">
