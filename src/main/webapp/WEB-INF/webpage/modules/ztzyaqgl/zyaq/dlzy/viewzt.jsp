...
<div class="hovertree-tracklist">
	<ul>
		<li class="first">
			<i class="node-icon"></i>
			<span class="time"><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${dlzy.s1 }" /></span>
			<span class="txt">申请断路作业安全证,作业证编号:${dlzy.m1 }</span>
		</li>

		<c:choose>
		   <c:when test="${dlzy.zt<1 }">  
			    <li>
					<i class="node-icon"></i>
		   ...
		   <c:otherwise> 
				<li class="last">
					<i class="node-icon"></i>
					<span class="time"><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${dlzy.m18 }" /></span>
		...
		<c:choose>
		   ...
		   <c:otherwise> 
				<li class="last">
					<i class="node-icon"></i>
					<span class="time"><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${dlzy.m12_2 }" /></span>
		...
		<c:if test="${fn:contains(dlzy.process, '2') }">
			<c:choose>
			   ...
			   <c:otherwise> 
					<li class="last">
						<i class="node-icon"></i>
						<span class="time"><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${dlzy.m13_2 }" /></span>
		...
		<c:if test="${fn:contains(dlzy.process, '3') }">
			<c:choose>
			   ...
			   <c:otherwise> 
					<li class="last">
						<i class="node-icon"></i>
						<span class="time"><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${dlzy.m14_2 }" /></span>
		...
		<c:if test="${fn:contains(dlzy.process, '4') }">
			<c:choose>
			   ...
			   <c:otherwise> 
					<li class="last">
						<i class="node-icon"></i>
						<span class="time"><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${dlzy.m15_2 }" /></span>
		...
		<c:if test="${fn:contains(dlzy.process, '5') }">
			<c:choose>
			   ...
			   <c:otherwise> 
					<li class="last">
						<i class="node-icon"></i>
						<span class="time"><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${dlzy.m16_2 }" /></span>
		...
		<c:if test="${fn:contains(dlzy.process, '6') }">
			<c:choose>
			   ...
			   <c:otherwise> 
					<li class="last">
						<i class="node-icon"></i>
						<span class="time"><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${dlzy.m17_2 }" /></span>
		...
		<c:choose>
		   ...
		   <c:otherwise> 
				<li class="last">
					<i class="node-icon"></i>
					<span class="time"><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${dlzy.m18_7 }" /></span>
		...
		<c:choose>
		   ...
		   <c:otherwise> 
				<li class="last">
					<i class="node-icon"></i>
					<span class="time"><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${dlzy.m19 }" /></span>
		...
		<c:choose>
		   ...
		   <c:otherwise> 
				<li class="last">
					<i class="node-icon"></i>
					<span class="time"><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${dlzy.m20 }" /></span>
