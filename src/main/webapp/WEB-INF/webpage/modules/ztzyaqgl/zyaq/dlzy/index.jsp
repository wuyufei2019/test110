...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/ztzyaqgl/zyaq/dlzy/index.js?v=1.4"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="zyaqgl_dlzy_tb" style="padding:5px;height:auto">
	<form id="searchFrom" action="" style="margin-bottom: 8px;" class="form-inline">				
	<div class="form-group">
		<shiro:hasPermission name="zyaqgl:gczy:viewall">
			<input name="aqgl_dlzy_cx_depid" class="easyui-combotree" style="height: 30px;" data-options="editable:false,panelHeight:180, valueField: 'id',textField: 'text',url:'${ctx}/system/department/idjson', prompt:'所属部门' "/>
		</shiro:hasPermission>
		<input type="text" id="aqgl_dlzy_cx_m1" name="aqgl_dlzy_cx_m1" class="easyui-textbox" style="height: 30px;" data-options="prompt: '作业证编号 '"/>
		<input type="text" id="aqgl_dlzy_cx_m2" name="aqgl_dlzy_cx_m2" class="easyui-textbox" style="height: 30px;" data-options="prompt: '申请单位'"/>
		<input class="easyui-combobox" name="aqgl_dlzy_cx_zt"  style="height: 30px;" data-options="panelHeight:'150', prompt: '作业证状态 ',editable:false ,data: [
																																		        {value:'0',text:'待编制'},
	...
	<div class="col-sm-12">
		<div class="pull-left">
		<span id="divper">
			<shiro:hasPermission name="zyaqgl:dlzy:add">
			...
			<shiro:hasPermission name="zyaqgl:dlzy:delete">
