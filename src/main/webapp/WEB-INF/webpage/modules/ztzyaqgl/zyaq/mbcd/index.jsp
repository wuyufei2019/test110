...
<html>
<head>
	<title>盲板抽堵作业信息</title>
	<meta name="decorator" content="default"/>
	<script type="text/javascript" src="${ctx}/static/model/js/ztzyaqgl/zyaq/mbcd/index.js?v=1.6"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="zyaqgl_mbcd_tb" style="padding:5px;height:auto">
	<form id="searchFrom" action="" style="margin-bottom: 8px;" class="form-inline">				
	<div class="form-group">
		<shiro:hasPermission name="zyaqgl:gczy:viewall">
			<input name="aqgl_mbcd_cx_depid" class="easyui-combotree" style="height: 30px;" data-options="editable:false,panelHeight:180, valueField: 'id',textField: 'text',url:'${ctx}/system/department/idjson', prompt:'所属部门' "/>
		</shiro:hasPermission>
		<input type="text" id="aqgl_mbcd_cx_m1" name="aqgl_mbcd_cx_m1" class="easyui-textbox" style="height: 30px;" data-options="prompt: '作业证编号 '"/>
		<input type="text" id="aqgl_mbcd_cx_m2" name="aqgl_mbcd_cx_m2" class="easyui-textbox" style="height: 30px;" data-options="prompt: '申请单位'"/>
		<input class="easyui-combobox" name="aqgl_mbcd_cx_zt"  style="height: 30px;" data-options="panelHeight:'150', prompt: '作业证状态 ',editable:false ,data: [
																																		        {value:'0',text:'待编制'},
																																		        {value:'1',text:'待作业单位确认'},
																																		        {value:'2',text:'待安技员审批'},
																																		        {value:'3',text:'待部门一把手审批'},
																																		        {value:'4',text:'待安全处分管领导审批'},
																																		        {value:'5',text:'待保卫部审批'},
																																		        {value:'6',text:'待公司分管领导措施'},
																																		        {value:'7',text:'待确认措施'},
																																		        {value:'8',text:'待作业单位完工签字'},
																																		        {value:'9',text:'待分厂单位完工签字'},
																																		        {value:'10',text:'已完工'}] "/>
	...
	<div class="col-sm-12">
		<div class="pull-left">
		<span id="divper">
			<shiro:hasPermission name="zyaqgl:mbcd:add">
			...
			<shiro:hasPermission name="zyaqgl:mbcd:delete">
