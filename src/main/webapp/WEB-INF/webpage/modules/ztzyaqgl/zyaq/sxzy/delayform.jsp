...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/ztzyaqgl/zyaq/sxzy/index.js?v=1.0"></script>
</head>
<body>

     <form id="inputForm" action="${ctx}/ztzyaqgl/sxzy/delay"  method="post" class="form-horizontal" >
