...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/sekb/whpaqxx/index.js?v=1"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="sekb_whpaqxx_tb" style="padding:5px;height:auto">
	...
	<div class="col-sm-12">
		<div class="pull-left">
			<shiro:hasPermission name="sekb:whpaqxx:view">
        		<button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="view()" title="查看"><i class="fa fa-search-plus"></i> 查看</button> 
        	</shiro:hasPermission>
        	<shiro:hasPermission name="sekb:whpaqxx:excel">
