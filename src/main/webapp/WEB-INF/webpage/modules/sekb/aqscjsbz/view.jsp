				...
				<c:if test="${not empty res.m4}">
					<c:set var="url" value="${fn:split(res.m4, '||')}" />
						<div  style="margin-bottom: 10px;">
							...
							<img src="${ctxStatic}/model/images/p.png"><a style="color:#337ab7;text-decoration:none;cursor:pointer;margin-right:20px;" onclick="window.open('${res.m5}')">${url[1]}.pdf</a>
						</div>
				</c:if>
			</div>
