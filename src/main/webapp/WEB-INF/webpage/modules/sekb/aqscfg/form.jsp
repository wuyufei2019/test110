...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/model/js/sekb/aqscfg/index.js"></script>
</head>
<body>

     <form id="inputForm" action="${ctx}/sekb/aqscfg/${action}"  method="post" class="form-horizontal" >
