...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/model/js/sekb/aqscfl/index.js"></script>
</head>
<body>

     <form id="inputForm" action="${ctx}/sekb/aqscfl/${action}"  method="post" class="form-horizontal" >
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
				...
				<c:if test="${not empty res.ID}">
					...
					<input type="hidden" name="S1" value="<fmt:formatDate value="${res.s1}" pattern="yyyy-MM-dd HH:mm:ss"  />" />
