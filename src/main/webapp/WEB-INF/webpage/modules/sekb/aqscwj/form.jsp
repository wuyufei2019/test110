...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/model/js/sekb/aqscwj/index.js"></script>
</head>
<body>

     <form id="inputForm" action="${ctx}/sekb/aqscwj/${action}"  method="post" class="form-horizontal" >
