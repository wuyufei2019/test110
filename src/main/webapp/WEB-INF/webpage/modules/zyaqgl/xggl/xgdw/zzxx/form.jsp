...
<body>
     ...
     <form id="inputForm" action="${ctx}/zyaqgl/zzxx/${action}"  method="post" class="form-horizontal" >
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
			  	<tr>
					<td class="width-15 active"><label class="pull-right">有效期起：</label></td>
					<td class="width-85"><input id="aqjg_dsf_zz_form_mainform_M4" name="M4"
				...
				<tr>
					...
					<td class="width-85"><input name="M5" class="easyui-datebox" value="${zz.m5 }"
				...
				<tr>
					...
					<td class="width-85"><input value="${zz.m1 }" name="M1" style="width: 100%;height: 30px;"
				...
				<tr>
					...
					<td class="width-85"><input name="M2" class="easyui-combobox" style="width: 100%;height: 30px;"
								value="${zz.m2 }"
				...
				<tr>
					...
					<td class="width-85"><input name="M3" class="easyui-textbox" value="${zz.m3 }"
