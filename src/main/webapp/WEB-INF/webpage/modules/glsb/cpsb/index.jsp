...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/glsb/cpsb/index.js?v=1.0"></script>
</head>
<body >
<!-- 工具栏 -->
   <div id="dg_tb" style="padding:5px;height:auto">
      <form id="searchFrom" style="margin-bottom: 8px;" class="form-inline">
         <div class="form-group">
            ...
            <input type="text" name="view_car_code" class="easyui-textbox" style="height: 30px;" data-options="prompt: '车牌号'" />
