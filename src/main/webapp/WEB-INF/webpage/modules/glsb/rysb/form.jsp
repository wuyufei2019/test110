...
<body>
<form id="inputForm" action="${ctx}/glsb/rysb/${action}" method="post" class="form-horizontal">
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            ...
            <td class="width-20 active"><label class="pull-right">人员名称：</label></td>
            <td class="width-30"><input name="ryname" class="easyui-textbox" value="${entity.ryname }"
                                        data-options="validType:'length[0,100]'" style="width: 100%;height: 30px;"/>
            </td>
        </tr>
        <tr>
