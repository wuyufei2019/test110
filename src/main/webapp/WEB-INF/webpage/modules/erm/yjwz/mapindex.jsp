...
<script type="text/javascript" src="${ctxStatic}/model/js/erm/yjwz/mapindex.js"></script>
...
<body>
   <div id="r-result" style="margin:5px;" >
		&nbsp;&nbsp;
		<input id="keyword" type="text" class="easyui-textbox" style="width:150px;" value="" data-options="prompt: '物资名称' " />
