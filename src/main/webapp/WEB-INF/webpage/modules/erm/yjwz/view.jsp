			  ...
			  <tbody>
				...
				<tr>
					...
					<td class="width-85" colspan="3">
					 <c:if test="${not empty res.m16}">
					 <c:forTokens items="${res.m16}" delims="," var="url" varStatus="urls">
				...
				<tr>
					...
					<td class="width-35" colspan="3">
					 <c:if test="${not empty res.m17}">
					 <c:forTokens items="${res.m17}" delims="," var="url" varStatus="urls">
					 	<c:set var="urlna" value="${fn:split(url, '||')}" />
...
<script type="text/javascript">
	...
	function init_map(){
		//地图初期化
		initMap("erm_yjzb_dlg_map_view",pointx, pointy);
