...
<body>
     ...
     <form id="inputForm" action="${ctx}/erm/yjcbk/${action}"  method="post" class="form-horizontal" >
			  ...
			  <tbody>
				...
				<tr >
					...
					<td class="width-35" colspan="3">
						<input style="width: 100%;height: 30px;" name="M2" class="easyui-textbox" value="${res.m2 }" data-options="validType:'length[0,100]'"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="width-35"><input style="width: 100%;height: 30px;" name="M3" class="easyui-textbox " value="${res.m3 }" data-options="required:'true',validType:'length[0,25]'"/></td>
					<td class="width-15 active"><label class="pull-right">负责人电话：</label></td>
					<td class="width-35"><input style="width: 100%;height: 30px;"name="M4" class="easyui-textbox" value="${res.m4 }" data-options="required:'true',validType:'mobile'"/></td>
				</tr>
				
				<tr>
					<td class="width-15 active"><label class="pull-right">库容：</label></td>
					<td class="width-35" colspan="3"><input style="width: 100%;height: 30px;"name="M6" class="easyui-textbox " value="${res.m6 }" data-options="validType:'length[0,10]'" /></td>
				</tr>
				
				<tr>
					<td class="width-15 active"><label class="pull-right">存放物品：</label></td>
					<td class="width-35" colspan="3"><input style="width: 100%;height: 30px;" name="M5" class="easyui-textbox " value="${res.m5 }" data-options="validType:'length[0,100]'"/></td>
				</tr>
					
				</tr>
				
				<tr> 
					<td class="width-15 active"><label class="pull-right">应对事故类型：</label></td><td colspan="3"><input type="checkbox" id="ydlx1" name="M9" value="1" /><a style="cursor:default;" onclick="ydlxChange1()">物体打击</a>
																		                <input type="checkbox" id="ydlx2" name="M9" value="2" /><a style="cursor:default;" onclick="ydlxChange2()">车辆伤害</a>
																		                <input type="checkbox" id="ydlx3" name="M9" value="3" /><a style="cursor:default;" onclick="ydlxChange3()">机械伤害</a>
																		                <input type="checkbox" id="ydlx4" name="M9" value="4" /><a style="cursor:default;" onclick="ydlxChange4()">起重伤害</a>
																		                <input type="checkbox" id="ydlx5" name="M9" value="5" /><a style="cursor:default;" onclick="ydlxChange5()">触电</a><br/>
																		                <input type="checkbox" id="ydlx6" name="M9" value="6" /><a style="cursor:default;" onclick="ydlxChange6()">淹溺</a>
																		                <input type="checkbox" id="ydlx7" name="M9" value="7" /><a style="cursor:default;" onclick="ydlxChange7()">灼烫</a>
																		                <input type="checkbox" id="ydlx8" name="M9" value="8" /><a style="cursor:default;" onclick="ydlxChange8()">火灾</a>
																		                <input type="checkbox" id="ydlx9" name="M9" value="9" /><a style="cursor:default;" onclick="ydlxChange9()">高处坠落</a>
																		                <input type="checkbox" id="ydlx10" name="M9" value="10" /><a style="cursor:default;" onclick="ydlxChange10()">坍塌</a><br/>
																		                <input type="checkbox" id="ydlx11" name="M9" value="11" /><a style="cursor:default;" onclick="ydlxChange11()">冒顶片帮</a>
																		                <input type="checkbox" id="ydlx12" name="M9" value="12" /><a style="cursor:default;" onclick="ydlxChange12()">透水</a>
																		                <input type="checkbox" id="ydlx13" name="M9" value="13" /><a style="cursor:default;" onclick="ydlxChange13()">放炮</a>
																		                <input type="checkbox" id="ydlx14" name="M9" value="14" /><a style="cursor:default;" onclick="ydlxChange14()">火药爆炸</a>
																		                <input type="checkbox" id="ydlx15" name="M9" value="15" /><a style="cursor:default;" onclick="ydlxChange15()">瓦斯爆炸</a><br/>
																		                <input type="checkbox" id="ydlx16" name="M9" value="16" /><a style="cursor:default;" onclick="ydlxChange16()">锅炉爆炸</a>
																		                <input type="checkbox" id="ydlx17" name="M9" value="17" /><a style="cursor:default;" onclick="ydlxChange17()">容器爆炸</a>
																		                <input type="checkbox" id="ydlx18" name="M9" value="18" /><a style="cursor:default;" onclick="ydlxChange18()">其它爆炸</a>
																		                <input type="checkbox" id="ydlx19" name="M9" value="19" /><a style="cursor:default;" onclick="ydlxChange19()">中毒和窒息</a>
																		                <input type="checkbox" id="ydlx20" name="M9" value="20" /><a style="cursor:default;" onclick="ydlxChange20()">其它伤害</a></td>
				</tr>
				...
				<input type="hidden" id="locx" name="locx" value="${res.m11 }"/>
				<input type="hidden" id="locy" name="locy" value="${res.m12 }"/>
			</table>
	...
	<div id="enterprise_dlg" style="width:100%;height:100%; text-align:center;display: none;" >
		<div><span style="color: red;margin: 0 10px;">点击地图标注应急储备库位置!</span>
...
$(function(){
	...
	if (action == 'create') {
		url="/erm/yjcbk/create";
		for(var i=1;i<=20;i++){
		$("input[name='M9']:checkbox[value='"+i+"']").attr('checked','true');
	}
	} else if (action == 'update') {
		url="/erm/yjcbk/update";
	} else if (action == 'view') {
		for(var i=1;i<=15;i++){
		...
		$("#erm_yjcbk_form_savebt").css('display','none');
		$("#map_test_divaxy").hide();
	}
	
	$(function(){ 
		$(".erm_yjcbk_form_id_table td").mouseover(function() {
			$(this).addClass("over");
		});
		$(".erm_yjcbk_form_id_table td").mouseout(function() {
