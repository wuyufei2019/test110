...
<script type="text/javascript" src="${ctxStatic}/model/js/erm/yjyy/mapindex.js"></script>
<script type="text/javascript" src="${ctx}/static/common/initmap.js?v=1.1"></script> 
</head>
<body>
   <div id="r-result" style="margin:5px;" >
		&nbsp;&nbsp;
		<input id="keyword" type="text" class="easyui-textbox" style="width:150px;" value="" data-options="prompt: '医院名称' " />
