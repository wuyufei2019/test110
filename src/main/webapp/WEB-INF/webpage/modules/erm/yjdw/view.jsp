...
<body>
     ...
     <form id="inputForm" class="form-horizontal" >
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
				...
				<tr>
					...
					<div id="erm_yjdw_dlg_map_view" style="width:100%;height: 100px;"></div>
				</tr>
 		...
 		<div id="yjdw_dlg" class="easyui-dialog" style="width:600px;height:450px;padding:10px 20px;text-align:center;"
                closed="true" >
			...
			<table cellspacing="2px" cellpadding="0" width="100%" style="margin:auto;text-align:left;"> 
				...
				<tr><td>
					<div id="erm_yjdw_dlg_map" style="width:100%;height: 300px;"></div>
				</td></tr>
			</table>  
        <div id="yjdw_dlg-buttons" style="text-align:center;">
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:$('#yjdw_dlg').dialog('close')" style="width:90px">取消</a>
        </div>
        </div>
<script type="text/javascript">
	...
	function init_map(){
		//地图初期化
		initMap("erm_yjdw_dlg_map_view",pointx, pointy);
