...
<script type="text/javascript" src="${ctxStatic}/model/js/erm/bncs/mapindex.js"></script>
...
<body>
   <div id="r-result" style="margin:5px;" >
		&nbsp;&nbsp;
		<input id="keyword" type="text" class="easyui-textbox" style="width:150px;" value="" data-options="prompt: '避难场所名称' " />
