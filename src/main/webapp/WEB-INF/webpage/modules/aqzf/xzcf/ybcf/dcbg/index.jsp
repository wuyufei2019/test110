...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/aqzf/xzcf/ybcf/dcbg/index.js?v=1.3"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="ybcf_dcbg_tb" style="padding:5px;height:auto">
	...
	<div class="form-group">
		<input type="text" name="ybcf_dcbg_qyname" class="easyui-textbox" style="height: 30px;" data-options="prompt: '企业名称'" />
		<input type="text" name="ybcf_dcbg_name" class="easyui-textbox" style="height: 30px;" data-options="prompt: '案件名称'" />
		调查时间：
		<input type="text" class="easyui-datebox" name="ybcf_dcbg_startdate"  style="height: 30px;" data-options="prompt: '开始时间'"  >
		<input type="text" class="easyui-datebox" name="ybcf_dcbg_enddate"  style="height: 30px;" data-options="prompt: '结束时间'"  >
