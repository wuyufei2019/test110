...
<div id="jycf_cfjd_tb" style="padding:5px;height:auto">
	...
	<div class="form-group">
		<input type="text" name="jycf_cfjd_name" class="easyui-textbox" style="height: 30px;" data-options="prompt: '申辩人姓名'" />
		<input type="text" class="easyui-datebox" name="jycf_cfjd_startdate"  style="height: 30px;" data-options="prompt: '开始时间'"  >
		<input type="text" class="easyui-datebox" name="jycf_cfjd_enddate"  style="height: 30px;" data-options="prompt: '结束时间'"  >
	...
	<div class="col-sm-12">
		<div class="pull-left">
			 <shiro:hasPermission name="jycf:cfjd:add">
        	...
        	<shiro:hasPermission name="jycf:cfjd:export">
        		<button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="fileexportsbjl()" title="导出"><i class="fa fa-external-link"></i> 导出处罚记录</button> 
        	</shiro:hasPermission>
