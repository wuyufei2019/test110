...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/aqzf/xzcf/ybcf/qzzx/index.js?v=1.3"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="xzcf_qzzx_tb" style="padding:5px;height:auto">
	...
	<div class="form-group">
		...
		<input type="text" name="xzcf_qzzx_name" class="easyui-textbox" style="height: 30px;" data-options="prompt: '单位名称'" />
