     ...
     <form id="inputForm" action="${ctx}/xzcf/ybcf/cfgz/${action}"  method="post" class="form-horizontal" >
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
				...
				<tr>
					...
					<td class="width-35"  >
					<input name="name" id="name" class="easyui-textbox" value="${jie.name }" style="width: 100%;height: 30px;" data-options="validType:['length[0,50]'],required:'true'"/>
					</td>
				...
				<tr>
					...
					<td class="width-35"  colspan="3"><input id="unlaw" name="unlaw"  class="easyui-textbox" value="${jie.unlaw }" style="width: 100%;height: 50px;" data-options="multiline:true,validType:['length[0,500]'],required:'true'"/></td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">处罚依据：</label></td>
					<td class="width-35" colspan="3"><input id="enlaw" name="enlaw"  class="easyui-textbox" value="${jie.enlaw }" style="width: 100%;height: 50px;" data-options="multiline:true,validType:['length[0,500]'],required:'true'"/></td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">处罚结果：</label></td>
					<td class="width-35" colspan="3"><input id="punishresult" name="punishresult"  class="easyui-textbox" value="${jie.punishresult }" style="width: 100%;height: 100px;" data-options="multiline:true , validType:['length[0,1000]'],required:'true'"/></td>
				</tr>
			<%-- 	<tr>
