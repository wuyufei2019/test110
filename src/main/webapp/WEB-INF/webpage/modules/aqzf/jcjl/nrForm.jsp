			...
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
			  	<tr>
					...
					<td class="width-85" >
					<input type="text" id="M1" name="M1" style="width: 100%;height: 30px;" class="easyui-combobox" data-options="required:true,editable:true ,valueField:'id',textField:'text',panelHeight:'100px',url:'${ctx}/aqzf/wfxw/idlist'"/>
					</td>
				</tr>				
				<tr>
