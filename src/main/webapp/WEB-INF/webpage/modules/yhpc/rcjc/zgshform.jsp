	...
	<form id="inputForm" action="${ctx}/yhpc/rcjc/${action}" method="post" class="form-horizontal">
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
            ...
            <tr>
				  ...
				  <td class="width-85" colspan="3">
					  <input type="radio" id="zgnopass" name="M13" value="3" class="i-checks"/><label for="zgnopass">未通过</label>&nbsp;&nbsp;&nbsp;&nbsp;
					  <input type="radio" id="zgpass" name="M13" value="4" class="i-checks"/><label for="zgpass">通过</label>
					 </td>
			  </tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">审核反馈：</label></td>
					<td class="width-35"  colspan="3"><input name="M17" style="width: 100%;height: 80px;" class="easyui-textbox"
															 value="${entity.m17 }" data-options="multiline: true, validType:['length[0,1000]']" /></td>
				</tr>
              <tr>
                  <td class="width-15 active"><label class="pull-right">稽核人：</label></td>
                  <td class="width-35" ><input name="M14" style="width: 100%;height: 30px;" class="easyui-textbox"
                                                           value="${entity.m14 }" data-options=" " /></td>
              </tr>
