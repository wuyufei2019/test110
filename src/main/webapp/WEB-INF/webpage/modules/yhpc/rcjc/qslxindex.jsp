...
$(function(){
	...
	columns:[[ 
            ...
            {field:'m1',title:'缺失类型',sortable:false,width:200,align: 'center'}
        ]],
...
//弹窗增加
function add() {
	openDialog("添加缺失类型",ctx+"/yhpc/rcjc/lxcreate/2","350px", "150px","");
}
...
function upd(){
	...
	openDialog("修改缺失类型信息",ctx+"/yhpc/rcjc/lxupdate/"+row.id,"350px", "150px","");
