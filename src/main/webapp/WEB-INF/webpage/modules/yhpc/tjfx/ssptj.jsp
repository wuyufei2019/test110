...
<body class="bggrey1">
      <div class="">
         <div class="col-lg-12">
            ...
            <div class="col-lg-2">
               <div class="btn-group" style="height: 30px ;margin: 8px 20px 8px 10px">
                  <button type="button" id="day" class="btn btn-white" onclick="countByTime(1)">&nbsp;天&nbsp;</button>
                  <button type="button" id="week" class="btn btn-white active" onclick="countByTime(2)">&nbsp;月&nbsp;</button>
         ...
         <div class="col-lg-12">
            ...
            <div class="col-lg-6" style="height: 30px ;margin: 8px 20px 8px 10px">
               <input type="text" id="member_starttime" name="time_starttime" class="easyui-datebox" style="height: 30px;" data-options="prompt: '开始时间'" />
