				...
				<tr>
					...
					<td class="width-35" colspan="3">
						...
						<div id="jcdIDs">
							...
							<div id="jcdList"></div>
							<a  href="javascript:void(0)"  class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" onclick="openjcdlist()" title="选择检查点"><i class="fa fa-plus"></i> 选择检查点</a>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td class="width-35" colspan="3">
						...
						<div id="xjryIDs">
							...
							<div id="xjryList"></div>
							<a  href="javascript:void(0)"  class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" onclick="openxjrylist()" title="选择巡检人员"><i class="fa fa-plus"></i> 选择巡检人员</a>
						</div>
					</td>
				</tr>
