...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/model/js/lydw/rygj/index.js"></script>
</head>
...
-->
<div class="plurBtn" style="">
    <div class="plurIc"></div>
</div>

<div class="plurBar overhid" style="">
...
<!-- 人员警报提示框-->
<div class="promt">
    <div class="alert alert-info alert-dismissable" id="polygon-info">
