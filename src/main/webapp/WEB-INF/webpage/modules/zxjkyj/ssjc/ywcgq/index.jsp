	...
	<div class="easyui-tabs" fit="true">
			<div title="图形显示" style="height:100%;">
				<div style="height: 99.5%">
					<iframe src="${ctx}/zxjkyj/ywcgq/view/${qyid}" frameborder="0" width="100%" height="100%"></iframe>
				</div>
			</div>
...
$(function(){   
    ...
    columns:[[    
        ...
        {field:'gj',title:'罐径(m)',sortable:false,width:60,align:'center',
     	...
     	{field:'ywcgqbh',title:'液位传感器编码',sortable:false,width:80,align:'center'},
        {field:'bjyw',title:'报警液位(cm)',sortable:false,width:100,align:'center',
         	formatter : function(value, row, index) {
        ...
        {field:'ywbjsj',title:'液位报警时间',sortable:false,width:80,align:'center',
