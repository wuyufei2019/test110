	...
	<div class="easyui-tabs" fit="true">
			<div title="图形显示" style="height:100%;">
				<div style="height: 99.5%">
					<iframe src="${ctx}/zxjkyj/ydqtcgq/view/${qyid}" frameborder="0" width="100%" height="100%"></iframe>
				</div>
			</div>
...
$(function(){   
    ...
    columns:[[    
        ...
        {field:'ydqtcgqbh',title:'有毒气体传感器编号',sortable:false,width:80,align:'center'},
        {field:'ydqtmc',title:'有毒气体名称',sortable:false,width:100,align:'center'},
        {field:'ydqtbjnd',title:'有毒气体报警浓度',sortable:false,width:100,align:'center',
        ...
        {field:'ydqtbjsj',title:'有毒气体报警时间',sortable:false,width:60,align:'center',
