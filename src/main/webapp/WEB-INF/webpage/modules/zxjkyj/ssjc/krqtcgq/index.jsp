	...
	<div class="easyui-tabs" fit="true">
			<div title="图形显示" style="height:100%;">
				<div style="height: 99.5%">
					<iframe src="${ctx}/zxjkyj/krqtcgq/view/${qyid}" frameborder="0" width="100%" height="100%"></iframe>
				</div>
			</div>
...
$(function(){   
    ...
    columns:[[    
        {field:'qyname',title:'企业名称',sortable:false,width:150,align:'center'},    
     	{field:'krqtcgqbh',title:'可燃气体传感器编码',sortable:false,width:100,align:'center'},
		{field:'krqtmc',title:'可燃气体名称',sortable:false,width:100,align:'center'},
        {field:'krqtbjnd',title:'报警浓度(% LEL)',sortable:false,width:100,align:'center',
        ...
        {field:'krqtbjsj',title:'报警时间',sortable:false,width:80,align:'center',
