	...
	<div id="ssjc_wl_tb" style="padding:5px;height:auto">
		...
		<div class="col-sm-12">
			...
			<div class="pull-left">
				...
				<input type="text" id="ssjc_wl_qy_name" name="ssjc_wl_qy_name" class="easyui-combobox"  style="height: 30px;width:250px;" data-options="editable:true ,valueField: 'text',textField: 'text',url:'${ctx}/zxjkyj/zdwxycg/qyjson',prompt: '企业名称',
	...
	<div class="easyui-tabs" fit="true">
				...
				<div id="ssjc_wl_tb" style="padding:5px;height:auto">
					<form id="searchFrom" action="" style="margin-bottom: 8px;" class="form-inline">
						<div class="form-group">
							<input name="cglx" id="cglx" class="easyui-combobox" style="height: 30px;"
			...
			<div title="图形显示" style="height:100%;">
				<div style="height: 99.5%">
					<iframe src="${ctx}/zxjkyj/zdwxycg/view/${qyid}" frameborder="0" width="100%" height="100%"></iframe>
				</div>
			</div>
	</div>
</c:if>
...
$(function(){   
    ...
    columns:[[    
		...
		{field:'zt',title:'状态',sortable:false,width:100,align:'center',
     	...
     	{field:'cz',title:'操作',sortable:false,width:150,align:'center',
     		formatter : function(value, row, index) {
     			var a = "";
				a+= "<a style='margin:2px' class='btn btn-info btn-xs' onclick=viewxq(" + row.tankid + ",'"+row.target_type+"'," + row.id + ")>详情</a>";
    ...
    onDblClickRow: function (rowdata, rowindex, rowDomElement){
		viewxq(rowindex.tankid, rowindex.target_type, rowindex.id);
    },
...
//显示企业储罐信息页面
function showqycg(n){
	openDialogView("实时储量",ctx+'/zxjkyj/zdwxycg/view/'+n,"100%", "100%","");
}

//查看详情
function viewxq(tankid, jctype, pointid){
	openDialogView("查看储罐实时监测信息",ctx+"/zxjkyj/zdwxycg/viewxq/"+tankid+"/"+jctype+"?pointid="+pointid,"1000px", "80%","");
}
