...
<body>
     <form id="inputForm" action="${ctx}/bis/gas/${action}"  method="post" class="form-horizontal" >
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
				...
				<tr >
                    ...
                    <td class="width-30"><input name="M2" class="easyui-combobox" value="${entity.m2 }" style="width: 100%;height: 30px;" data-options="editable:false ,panelHeight:'auto' ,data: [
								        {value:'管道',text:'管道'},
								        {value:'瓶组',text:'瓶组'},
								        {value:'储罐',text:'储罐'} ]"/></td>
				</tr>
				<tr>
					...
					<td class="width-30"><input name="M4" class="easyui-textbox" value="${entity.m4 }" style="width: 100%;height: 30px;" data-options="required:false, validType:'number'" /></td>
				</tr>
				<tr>
					<td class="width-20 active"><label class="pull-right">瓶组数量：</label></td>
					<td class="width-30">
                        <input name="M5" class="easyui-numberbox" value="${entity.m5 }" style="width: 100%;height: 30px;" data-options="required:false, min:0, precision:0" />
                    </td>
					<td class="width-20 active"><label class="pull-right">瓶组体积（KG）：</label></td>
					<td class="width-30"><input class="easyui-textbox" name="M6" value="${entity.m6 }" style="width: 100%;height: 30px;" data-options="required:false, validType:'number'"/></td>
				</tr>
				<tr >
					<td class="width-20 active"><label class="pull-right">管道用量（m³/月）：</label></td>
					<td class="width-30" colspan="3">
					<input class="easyui-textbox" name="M7" value="${entity.m7 }" style="width: 100%;height: 30px;" data-options="
								required:false, validType:'number'"/>
					</td>
				</tr>
