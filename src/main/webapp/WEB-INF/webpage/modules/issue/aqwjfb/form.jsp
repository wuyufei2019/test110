...
<script type="text/javascript"
	src="${ctx}/static/model/js/aqwj/aqwjfb/index.js"></script>
</head>
<body>

	<form id="inputForm" action="${ctx}/issue/aqwjfb/${action}" method="post" class="form-horizontal">
				...
				<tr>
					...
					<td class="width-35" colspan="3">
						...
						<div id="qyIDs">
							...
							<a  href="javascript:void(0)"  class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" onclick="openqylist('${action}','${sfr.ID}')" title="选择企业"><i class="fa fa-plus"></i> 选择企业</a><span id="tip" style="color:red">（如果不选择，则默认发送给所有企业）</span>
							<div id="qyList"></div>
						</div>
					</td>
				</tr>
