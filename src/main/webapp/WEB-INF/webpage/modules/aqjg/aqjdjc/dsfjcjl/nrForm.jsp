			...
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
			  	<tr>
					...
					<td class="width-35" colspan="3"><input id="M1" name="M1" type="text"  class="easyui-textbox" value="${czwt.m1 }"  data-options="required:true, multiline:true"  style="width: 100%;height: 80px" /></td>
				</tr>				
				<tr>
