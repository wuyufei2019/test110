...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/aqjg/aqjdjc/dsfjcjl/index.js?v=1.3"></script>
			  ...
			  <tbody>
			  	...
			  	<tr>
					...
					<td class="width-35" colspan="3"><input value="${dsfjcjl.ID2 }" name="ID2" style="width: 100%;height: 30px;"
							...
							data-options="readonly:'true', panelHeight:'auto', editable:false,valueField:'id2',textField:'text',url:'${ctx }/dsffw/fwxmbb/dwnamelist',required:'true'" /></td>
				</tr>
				...
				<tr>
					...
					<td class="width-35"><input id="SignedStartDate" name="M2" class="easyui-datebox" value="${dsfjcjl.m2 }" style="width: 100%;height: 30px;" data-options="readonly:'true', required:'true', editable:true " /></td>
										<td class="width-15 active"><label class="pull-right">整改期限：</label></td>
					<td class="width-35"><input id="SignedEndDate" name="M3" class="easyui-datebox" value="${dsfjcjl.m3 }" style="width: 100%;height: 30px;" data-options="readonly:'true', required:'true', editable:true, validType:'equaldDate[\'#SignedStartDate\']' " /></td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">检查人员：</label></td>
					<td class="width-35"><input name="M4" class="easyui-textbox" value="${dsfjcjl.m4 }" style="width: 100%;height: 30px;" data-options="readonly:'true', required:'true', validType:'length[0,25]' " /></td>
					<td class="width-15 active"><label class="pull-right">整改负责人：</label></td>
					<td class="width-35"><input name="M5" class="easyui-textbox" value="${dsfjcjl.m5 }" style="width: 100%;height: 30px;" data-options="readonly:'true', required:'true', validType:'length[0,25]' " /></td>
				</tr>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			<tbody>
				...
				<tr>
					...
					<td class="width-35"><input id="M8" name="M8" class="easyui-datebox" value="${dsfjcjl.m8 }" style="width: 100%;height: 30px;" data-options="required:'true', editable:true " /></td>
					<td class="width-15 active"><label class="pull-right">复查人员：</label></td>
					<td class="width-35"><input name="M9" class="easyui-textbox" value="${dsfjcjl.m9 }" style="width: 100%;height: 30px;" data-options="required:'true', validType:'length[0,25]' " /></td>
				</tr>
				...
				<c:if test="${not empty dsfjcjl.ID}">
					<input type="hidden" name="M13" value="${checkflag} " />
