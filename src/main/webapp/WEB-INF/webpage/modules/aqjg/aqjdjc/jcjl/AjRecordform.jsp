...
<body>
     ...
     <form id="inputForm" action="${ctx}/aqjd/jcjl/${action}" method="post" class="form-horizontal">
          <tbody>
               <div class="easyui-accordion" style="width:100%;height:100%">
                    ...
                    <div title="安监局初检记录" iconCls="icon-add" selected="true" style="padding:10px;">
                         <table
                              class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
                              <tr>
                                   <td class="width-15 active"><label class="pull-right">检查人员姓名：</label></td>
                                   <td class="width-35"><input name="checkname"
                                             class="easyui-textbox" value="${acre.checkname }"
                                             style="width: 100%;height: 30px;" /></td>

                              </tr>
                              <tr>
                                   <td class="width-15 active"><label class="pull-right">企业负责人姓名：</label></td>
                                   <td class="width-35"><input name="businessperson"
                                             class="easyui-textbox" value="${acre.businessperson }"
                                             style="width: 100%;height: 30px;" /></td>
                                   <td class="width-15 active"><label class="pull-right">检查时间：</label></td>
                                   <td class="width-35"><input name="checkdate"
                                             class="easyui-datebox" value="${acre.checkdate }"
                                             style="width: 100%;height: 30px;" /></td>
                              </tr>

                              <tr>
                                   <td class="width-15 active"><label class="pull-right">检查意见汇总：</label></td>
                                   <td class="width-85" colspan="3"><input name="opinion"
                                             type="text" value="${acre.opinion }"
                              ...
                              <tr>
                                   ...
                                   <td class="width-35" colspan="3">
                                        <div id="uploader_ws_fjurl">
                                             <div id="qyfjurlfileList" class="uploader-list"></div>
                    ...
                    <div title="检查单位：主要负责人（企业）" iconCls="icon-add" selected="true"
                    style="padding:10px;">
                         <table
                              class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
                              ...
                              <tr>
                                   ...
                                   <td class="width-35"><fmt:parseDate value="${cre.m6 }"
                                             var="myDate" /> <fmt:formatDate value="${myDate}"
                                             pattern="yyyy-MM-dd" /></td>
                              </tr>
                         </table>
               </div>
                    <div title="检查单位：分管负责人（企业）" iconCls="icon-add" selected="true"
                    style="padding:10px;">
                         <table
                              class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
                              ...
                              <tr>
                                   ...
                                   <td class="width-15 active"><label class="pull-right">整改期限至：</label></td>
                                   <td class="width-35"><fmt:parseDate value="${cre.m10 }"
                                             var="myDate" /> <fmt:formatDate value="${myDate}"
                                             pattern="yyyy-MM-dd" /></td>
                              </tr>
                         </table>
                    ...
                    <div title="检查单位：安环部（企业）" iconCls="icon-add" selected="true"
                    style="padding:10px;">
                         <table
                              class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
                              ...
                              <tr>
                                   ...
                                   <td class="width-15 active"><label class="pull-right">整改期限至：</label></td>
                                   <td class="width-35"><fmt:parseDate value="${cre.m14 }"
                                             var="myDate" /> <fmt:formatDate value="${myDate}"
                                             pattern="yyyy-MM-dd" /></td>
                              </tr>
                         </table>
                    ...
                    <div title="检查单位：其他部门（企业）" iconCls="icon-add" selected="true"
                    style="padding:10px;">
                         <table
                              class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
                              ...
                              <tr>
                                   ...
                                   <td class="width-15 active"><label class="pull-right">整改期限至：</label></td>
                                   <td class="width-35"><fmt:parseDate value="${cre.m18 }"
                                             var="myDate" /> <fmt:formatDate value="${myDate}"
                                             pattern="yyyy-MM-dd" /></td>
                              </tr>
                         </table>
                    ...
                    <div title="企业初检附件" iconCls="icon-add" selected="true" style="padding:10px;">
                         <table
                              class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
                              <tr>
                                   <td class="width-15 active" style="width:6.5%"><label
                                             class="pull-right">隐患照片：</label></td>
                                   <td class="width-35" colspan="3"><c:if
                                             test="${not empty cre.m23}">
                                             <c:forTokens items="${cre.m23}" delims="," var="url"
                                                  varStatus="urls">
                                                  <c:set var="urlna" value="${fn:split(url, '||')}" />
                                                  <div
                                                       style="float: left;text-align: center;margin: 0 10px 10px 0;">
                                                       <img src="${urlna[0]}" alt="${urlna[1]}"
                                                       width="300px;" /><br />
                                                  <a target="_blank" href="${urlna[0]}">${urlna[1]}</a>
                                                  </div>
                                             </c:forTokens>
                                        </c:if></td>
                              </tr>
                              ...
                              <tr>
                                   <td class="width-15 active"><label class="pull-right">检查表附件：</label></td>
                                   <td class="width-35" colspan="3"><c:if
                                             test="${not empty cre.qyurl}">
                                             <c:forTokens items="${cre.qyurl}" delims="," var="url"
                                                  varStatus="urls">
                                                  <c:set var="urlna" value="${fn:split(url, '||')}" />
                                                  <div style="margin: 5px;"><a
                                                            style="color:#337ab7;text-decoration:none;"
                                                            target="_blank" href="${urlna[0]}">${urlna[1]}</a>
                                                  </div>
                                             </c:forTokens>
                                        </c:if></td>
                              </tr>
                    ...
                    <div title="企业复检记录" iconCls="icon-add" selected="true" style="padding:10px;">
                         ...
                         <table
                              ...
                              <tr>
                                   ...
                                   <td class="width-35"><fmt:parseDate value="${cre.m20 }"
                                             var="myDate" /> <fmt:formatDate value="${myDate}"
                                             pattern="yyyy-MM-dd" /></td>
                              ...
                              <c:if
                                   test="${cre.checkflag eq 1 or cre.checkflag eq 2 or cre.checkflag eq 3}">
                                   <tr>
                                        <td class="width-15 active" style="width:6.5%"><label
                                                  class="pull-right">复检隐患照片：</label></td>
                                        <td class="width-35" colspan="3"><c:if
                                                  test="${not empty cre.m24}">
                                                  <c:forTokens items="${cre.m24}" delims=","
                                                       var="url" varStatus="urls">
                                                       <c:set var="urlna"
                                                            value="${fn:split(url, '||')}" />
                                                       <div
                                                            style="float: left;text-align: center;margin: 0 10px 10px 0;">
                                   ...
                                   <tr>
                                        ...
                                        <td class="width-35" colspan="3"><c:if
                                                  test="${not empty cre.qyurl}">
                                                  <c:forTokens items="${cre.qyurl}" delims=","
                                                       var="url" varStatus="urls">
                                                       <c:set var="urlna"
                                                            value="${fn:split(url, '||')}" />
                                                       <div style="margin: 5px;"><a
                              ...
                              <!-- 隐藏域 -->
                              <input type='hidden' id="id1"name="id1" value="${acre.id1}" />
                              <input type='hidden' name="ID" value="${acre.ID}" />
                              <input type='hidden' name="S1" value="<fmt:formatDate value="${acre.s1 }"/>" />
                         </table>
               </div>
     ...
     <script type="text/javascript">
		...
		if('${action}'=='createAjRecord'){
			$("#id1").val(${cre.ID});
		}
		var $ = jQuery, $list = $('#urlfileList'), $list2 = $('#qyfjurlfileList');//附件上传; 
		...
		// 图片上传成功，显示预览图
		uploader.on('uploadSuccess', function(file, acre) {
			$.jBox.closeTip();
			if (acre.error == 0) {
				var $li = $("<div id=\"" + file.id + "\" class=\"file-item thumbnail\">" + "<span class=\"cancel\" onClick=\"removeFile('" + file.id
						+ "')\" style=\"cursor: pointer\">删除</span>" + "<img>" + "<div class=\"info\">" + file.name + "</div>" + "</div>"), $img = $li.find('img');
		...
		fileuploader.on('uploadSuccess', function(file, acre) {
			...
			if (acre.error == 0) {
				...
				var $input = $('<input id="input_'+file.id+'" type="hidden" name="fjurl" value="'+newurl+'"/>');

				$('#uploader_ws_fjurl').append($input);
			} else {
				layer.msg(acre.message, {
					time : 3000
				});
		...
		if ('${action}' == 'updateAjRecord') {
			...
			if (zpUrl != null && zpUrl != '' && zpUrl != 'null') {
				...
				for (var i = 0; i < arry.length; i++) {
					...
					var id = "ws_zp_" + i;
					var $li = $("<div id=\"" + id + "\" class=\"file-item thumbnail\">" + "<span class=\"cancel\" onClick=\"removeFile('" + id
							+ "')\" style=\"cursor: pointer\">删除</span>" + "<img src=\""+arry2[0]+"\" style=\"width:100px; height: 100px\">" + "<div class=\"info\">" + arry2[1]
							+ "</div>" + "</div>");
			...
			if (fjUrl != null && fjUrl != '') {
				...
				for (var i = 0; i < arry.length; i++) {
					...
					var $li = $("<div id=\"" + id + "\" style=\"margin-bottom: 10px;\">"
							...
							+ "<span class=\"ss\" onClick=\"removeFile('" + id + "')\" style=\"cursor: pointer\">删除</span>" + "</div>");
					$list2.append($li);

					var $input = $('<input id="input_'+id+'" type="hidden" name="fjurl" value="'+arry[i]+'"/>');
					$('#uploader_ws_fjurl').append($input);
				}
			}
		}
