...
<script type="text/javascript" src="${ctx}/static/model/js/fxgk/fxpg/jha/index.js?v=1.2"></script>
</head>
<body>
   <!-- 工具栏 -->
   <div id="fxpg_jha_tb" style="padding:5px;height:auto">
      ...
      <div class="row">
         <div class="col-sm-12">
            <div class="pull-left">
               ...
               <shiro:hasPermission name="fxpg:jha:update">
