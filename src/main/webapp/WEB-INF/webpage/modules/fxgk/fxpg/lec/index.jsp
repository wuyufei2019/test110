...
<script type="text/javascript" src="${ctx}/static/model/js/fxgk/fxpg/lec/index.js?v=1.3"></script>
</head>
<body>
   <!-- 工具栏 -->
   <div id="fxpg_lec_tb" style="padding:5px;height:auto">
      <form id="searchFrom" action="" style="margin-bottom: 8px;" class="form-inline">
         <div class="form-group">
            ...
            <input type="text" name="view_deptname" class="easyui-combobox" style="height: 30px;"
            ...
            <input type="text" name="view_jobname" class="easyui-combobox" style="height: 30px;"
               data-options="prompt: '岗位/工种名称',panelHeight:'100',valueField: 'text',textField: 'text',url:'${ctx}/bis/gzxx/textjson'" />
