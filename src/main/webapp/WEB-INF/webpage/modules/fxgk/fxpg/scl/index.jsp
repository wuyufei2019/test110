...
<script type="text/javascript" src="${ctx}/static/model/js/fxgk/fxpg/scl/index.js?v=1.2"></script>
</head>
<body>
   <!-- 工具栏 -->
   <div id="fxpg_scl_tb" style="padding:5px;height:auto">
