...
<body>
<form id="inputForm"  action="${ctx}/fxpg/scl/${action}" method="post" class="form-horizontal">
   <table id="rwtable" class="table table-bordered">
      <tbody>
         <tr>
            <td class="width-20 active"><label class="pull-right">检查项目：</label></td>
            <td class="width-30" colspan="3"><input id="project" name="project" type="text" value="${entity.project }" class="easyui-textbox"
                  style="width: 100%;height: 30px;" data-options="required:true, validType:'length[0,250]' ">
         </tr>
         <tr>
            <td class="width-20 active"><label class="pull-right">检查标准：</label></td>
            <td class="width-30" colspan="3"><input name="standard" id="standard" style="width: 100%;height: 50px;"
                  class="easyui-textbox" value="${entity.standard }" data-options="multiline:true , validType:'length[0,250]'" /></td>
         </tr>
         <tr>
            <td class="width-20 active"><label class="pull-right">不符合标准主要后果：</label></td>
            <td class="width-30" colspan="3"><input name="mainresult" id="mainresult" style="width: 100%;height: 50px;" class="easyui-textbox"
                  value="${entity.mainresult }" data-options="multiline:true , validType:'length[0,250]'" /></td>
         </tr>
         <tr>
            <td class="width-20 active"><label class="pull-right">现有安全措施：</label></td>
            <td class="width-30" colspan="3"><input name="safetymeasure" id="safetymeasure" style="width: 100%;height: 50px;"
                  class="easyui-textbox" value="${entity.safetymeasure }" data-options="multiline:true , validType:'length[0,250]'" /></td>
         </tr>
         <tr>
            <td class="width-20 active"><label class="pull-right">可能性：</label></td>
            <td class="width-30" colspan="3"><input name="possibility" id="possibility" style="width: 100%;height: 30px;" class="easyui-combobox"
                  value="${entity.possibility }"/></td>
         </tr>
         <tr>
            <td class="width-20 active"><label class="pull-right">严重度：</label></td>
            <td class="width-30" colspan="3"><input name="severity" id="severity" style="width: 100%;height: 30px;" class="easyui-combogrid"
                  value="${entity.severity }" /></td>
         </tr>
         <tr>
            <td class="width-20 active"><label class="pull-right">风险值：</label></td>
            <td class="width-30"><input name="riskvalue" id="riskvalue" style="width: 100%;height: 30px;" class="easyui-textbox"
                  value="${entity.riskvalue }" data-options="readonly:true" /></td>
            <td class="width-20 active"><label class="pull-right">风险等级：</label></td>
            <td class="width-30"><input name="risklevel" id="risklevel" style="width: 100%;height: 30px;" class="easyui-textbox"
                  value="${entity.risklevel }" data-options="readonly:true" /></td>
         </tr>
         <tr>
            <td class="width-20 active"><label class="pull-right">改进措施：</label></td>
            <td class="width-30" colspan="3"><input name="improvemeasure" id="improvemeasure" style="width: 100%;height: 30px;"
