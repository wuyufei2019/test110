		...
		<table
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<label><input id="radio1" name="radio1" type="radio" value="1" />LEC </label>
						<label><input id="radio3" name="radio1" type="radio" value="3" checked/>LS </label>
					</td>
				</tr>
				...
				<tr>
					<td class="width-20 active"><label class="pull-right" style="color: red;">风险分级/风险标识：</label></td>
				...
				<tr>
				<td class="width-20 active"><label class="pull-right">场所/环节/部位：</label></td>
				<td class="width-80" colspan="3"><input  style="width: 100%;height: 30px;"class="easyui-textbox" id="sgfx_fxxx_m6" name="M6" value="${sgfx.m6 }"  data-options="required:'true',
								validType:['length[0,50]'],panelHeight:'150',editable:true ,valueField: 'text',textField: 'text'"/></td>
				</tr>

				<tr>
					<td class="width-20 active"><label class="pull-right">可能导致的事故类型 ：</label></td>
            ...
            <tr>
				...
				<tr>
					<td class="width-20 active"><label class="pull-right">主要防范措施：</label></td>
					<td class="width-80" colspan="3"> 
					...
					<td class="width-80" colspan="3">
						<div>
							<input id="M15" name="M15" class="easyui-combobox" value="${sgfx.m15 }" style="width: 100%;height: 30px;" data-options="validType:['length[0,500]'],editable:false,multiple:true,panelHeight:'auto', data: [
												        {value:'公司',text:'公司'},
												        {value:'责任单位',text:'责任单位'},
												        {value:'生产车间',text:'生产车间'},
												        {value:'班组',text:'班组'}]"/>
						</div>
					</td>
				...
				<tr>
					...
					<td class="width-20 active"><label class="pull-right">责任单位：</label></td>
					<td class="width-30">
						<input style="width: 100%;height: 30px;" name="fjgk2" class="easyui-textbox " value="${sgfx.fjgk2 }" data-options="validType:'length[0,50]'"/>
					</td>
				</tr>
				<tr>
					<td class="width-20 active"><label class="pull-right">生产车间：</label></td>
					<td class="width-30">
	...
	<script type="text/javascript">
		...
		$("#M9").combobox({
			onChange: function (n,o) {
				...
				if(level=='红')
					$('#M15').combobox('setValues','公司,责任单位,生产车间,班组'.split(','));
				if(level=='橙')
					$('#M15').combobox('setValues','责任单位,生产车间,班组'.split(','));
				if(level=='黄')
					$('#M15').combobox('setValues','生产车间,班组'.split(','));
				if(level=='蓝')
					$('#M15').combobox('setValues','班组'.split(','));
			}
		});
