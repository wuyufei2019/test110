...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/fxgk/fxdxx2/index.js?v=1.4"></script>
	<script type="text/javascript">
	   ...
	   $(function() {
			...
			dg = $('#fxgk_fxxx_dg').datagrid(
		        ...
		        {field:'m6',title:'场所/环节/部位',sortable:false,width:100,align:'center'},
				{field:'m8',title:'可能导致的事故类型',sortable:false,width:100,align:'center'},
		        {field:'m9',title:'风险分级/风险标识',sortable:false,width:100,align:'center',
...
<div id="fxgk_fxxx_tb" style="padding:5px;height:auto">
	...
	<div class="form-group">
		...
		<input type="text" name="fxgk_fxxx_depid" style="height: 30px;" class="easyui-combotree" style="width: 100%;height: 30px;" data-options="prompt:'分厂', valueField:'id', textField:'text', panelHeight:'200',url:'${ctx}/system/department/idjson',method:'GET'"/>
	...
	<div class="col-sm-12">
		<div class="pull-left">
			...
			<shiro:hasPermission name="fxgk:fxxx:enable">
				...
				<button class="btn btn-white btn-sm " data-toggle="tooltip" data-placement="left" onclick="openImportDialog('${ctx}/fxgk/fxxx/exinjump','${ctx}/fxgk/fxxx2/exin','${ctx}/static/templates/风险辨识导入模板2.xls')" title="导入"><i class="fa fa-folder-open-o"></i> 导入</button>
