...
<body>
	...
	<div id="sbssgl_sbdx_ndbb_tb" style="padding:5px;height:auto"></div>
		<table id="sbssgl_sbdx_ndbb_dg"></table> 	
	
<script type="text/javascript">
	var dg=$('#sbssgl_sbdx_ndbb_dg').datagrid({    
		method: "post",
	    url: ctx+'/sbssgl/sbdx/ndbblist', 
	    fit : true,
		fitColumns : true,
		border : false,
		idField : 'id',
		...
		checkOnSelect:false,
		selectOnCheck:false,
	    toolbar:'#sbssgl_sbdx_ndbb_tb'
	});
		
	function upload(){
		openDialog("上传年度报表",ctx+"/sbssgl/sbdx/uploadndbb","80%", "100%","");
	}
</script>
</body>
</html>
