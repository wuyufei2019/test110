...
<html>
<head>
<title>查看设备一级保养计划</title>
<meta name="decorator" content="default" />
<script type="text/javascript" src="${ctx}/static/model/js/sbssgl/sbbyjl/fir/view.js?v=1.0"></script>
</head>
<body>
	<div id="sbssgl_sbbystask_fir_tb" style="padding:5px;height:auto">
		<table id="rwtable" class="table table-bordered">
			<tbody class="w36">
				<tr class="w36">
					<td colspan="16" style="width: 100%;text-align: center"><span style="font-size: 18px;font-weight: bold;padding-top:10px">${entity.year } 年 ${entity.month }月 设备一级保养记录表</span></td>
   				</tr>
   				<tr>
