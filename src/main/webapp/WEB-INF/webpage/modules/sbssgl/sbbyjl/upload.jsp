...
<body>
	<form id="inputForm" action="${ctx}/sbssgl/sbbyjl/uploadfj" method="post" class="form-horizontal">
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
			<tbody>
				...
				<input type="hidden" name="type" value="${type}" /><!-- 保养计划类别 -->
			</tbody>
		</table>
	</form>
