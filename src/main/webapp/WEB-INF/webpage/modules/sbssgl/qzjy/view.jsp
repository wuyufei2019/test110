		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			...
			<c:if test="${sbtype eq '1'}">
				...
				<tr>
					...
					<td class="width-25" style="height: 30px;"><fmt:formatDate pattern="yyyy-MM-dd" value="${sbgl.m6 }" /></td>
				</tr>
				<tr>
					<td class="width-25 active"><label class="pull-right">价格：</label></td>
					<td class="width-25" style="height: 30px;">${sbgl.m7 }</td>
					<td class="width-25 active"><label class="pull-right">系列号：</label></td>
					<td class="width-25" style="height: 30px;">${sbgl.m9 }</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="width-25" style="height: 30px;">${sbgl.m14 }</td>
				...
				<tr>
					...
					<td class="width-25" style="height: 30px;">${sbgl.m17 }</td>
				</tr> 
				<%-- <tr> 
                  <td class="width-15 active"><label class="pull-right">设备正面照片：</label></td>
              ...
              <tr> 
                  <td class="width-15 active"><label class="pull-right">设备侧面照片：</label></td>
   				  <td class="width-35" colspan="3">
   				  	  <c:if test="${not empty sbgl.m24}">
              ...
              <tr> 
                  <td class="width-15 active"><label class="pull-right">设备铭牌照片：</label></td>
   				  <td class="width-35" colspan="3">
   				  	  <c:if test="${not empty sbgl.m25}">
