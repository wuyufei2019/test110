...
<body>
	<form id="inputForm" action="${ctx}/sbssgl/sbsq/shjg" method="post" class="form-horizontal">
		...
		<div id="tgMsg" style="color: red; text-align: center;">注：选择通过后信息不能修改，请仔细核对信息</div>
	</form>
