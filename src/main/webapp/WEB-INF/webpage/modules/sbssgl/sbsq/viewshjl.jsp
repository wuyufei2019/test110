...
var sbsqid = '${sbsqid}';//设备申请id
var dg;
$(function(){
	dg=$('#sbssgl_shjl_dg').datagrid({    
	method: "post",
    url:ctx+'/sbssgl/sbsq/shjllist/'+sbsqid, 
    fit : true,
	fitColumns : true,
	border : false,
	idField : 'id',
    ...
    columns:[[    
        ...
        {field:'m1',title:'审核结果',sortable:false,width:50,align:'center',
        	...
        	styler: function(value, row, index){
            	if (value == '0') {//当状态为不通过时，背景颜色为红色 
            		return 'background-color: #ed5565';
        		} else if (value == '1') {//当状态为通过时，背景颜色为绿色    #f8ac59
            		return 'background-color: #23c6c8'; 
        		} 
        	} 
        },
        {field:'shrname',title:'审核人',sortable:false,width:70,align:'center'},
        {field:'m2',title:'不通过原因',sortable:false,width:50,align:'center'},
