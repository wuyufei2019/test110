...
<div class="shadow">
	<div style="padding: 30px 35px;">
	  	<div  class="fltitle" >${gzzd.m1 }</div>
	  	<div  class="intro" >发布日期: <fmt:formatDate pattern="yyyy-MM-dd" value="${gzzd.m2 }" /></div>
	  	<hr />
		<br />
	  	<div >
				...
				<c:if test="${not empty gzzd.m3}">
					<c:set var="url" value="${fn:split(gzzd.m3, '||')}" />
						<div  style="margin-bottom: 10px;">
							...
							<img src="${ctxStatic}/model/images/p.png"><a style="color:#337ab7;text-decoration:none;cursor:pointer;margin-right:20px;" onclick="window.open('${gzzd.m9}')">${url[1]}.pdf</a>
						</div>
				</c:if>
			</div>
