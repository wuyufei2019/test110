		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			<tbody>
				...
				<tr >
					...
					<td class="width-30" >
						<input id="m4" name="m4" class="easyui-textbox" style="width: 100%;height: 30px;" value="${qgsb.m1 }" data-options="required:'true',validType:'length[0,50]'" />
					</td>
				</tr>
				<tr >
					<td class="width-20 active"><label class="pull-right">规格/型号：</label></td>
					<td class="width-30" >
						<input id="m5" name="m5" class="easyui-textbox" style="width: 100%;height: 30px;" value="${qgsb.m2 }" data-options="validType:'length[0,50]'" />
					</td>
				...
				<tr >
					...
					<td class="width-30" >
						<input id="m7" name="m7" class="easyui-textbox" style="width: 100%;height: 30px;" value="${qgsb.m3 }" data-options="validType:'length[0,50]'" />
					</td>
