...
<body>
	<form id="inputForm" action="${ctx}/sbssgl/sbgl/${action}"  method="post" class="form-horizontal" >
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			<tbody>
				...
				<tr>
					...
					<td class="width-30" >
						<input id="m20" name="m20" class="easyui-combobox" style="width: 100%;height: 30px;" value="${sbgl.m20 }" data-options="panelHeight:'auto',
																			data: [
																				{'value': '0', 'text': 'A类'},
																				{'value': '1', 'text': 'B类'},
																				{'value': '2', 'text': 'C类'},
					...
					<td class="width-30" >
						<input id="m21" name="m21" class="easyui-combobox" style="width: 100%;height: 30px;" value="${sbgl.m21 }" data-options="required:'true',editable:false, panelHeight:'auto',
																			data: [
																				{'value': '0', 'text': '否'},
																				{'value': '1', 'text': '是'},
																			]" />
				...
				<tr>
					...
					<td class="width-30" >
						<input id="m11" name="m11" class="easyui-textbox" style="width: 100%;height: 30px;" value="${sbgl.m11 }" data-options="validType:'length[0,50]'" />
					</td>
				</tr>
				<tr>
					<td class="width-20 active"><label class="pull-right">用水量：</label></td>
					<td class="width-30" >
						<input id="m12" name="m12" class="easyui-textbox" style="width: 100%;height: 30px;" value="${sbgl.m12 }" data-options="validType:'length[0,10]'" />
					</td>
		...
		<c:if test="${not empty sbgl.ID}">
			...
			<input type="hidden" name="m19" value="${sbgl.m19}" />
		</c:if>			
	</form>
<script type="text/javascript">
