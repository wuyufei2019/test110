				...
				<div class="col-sm-12">
					<div class="pull-left">
				       	<form id="rcpxtj_searchFrom2" style="margin-bottom: 8px;" action="" class="form-inline" >
				       		<input type="text" id="aqpx_pxtj_qyname" name="aqpx_pxtj_qyname" class="easyui-combobox"  style="height: 30px;" data-options="editable:true ,valueField: 'text',textField: 'text',url:'${ctx}/bis/qyjbxx/idjson',prompt: '企业名称' "/>
