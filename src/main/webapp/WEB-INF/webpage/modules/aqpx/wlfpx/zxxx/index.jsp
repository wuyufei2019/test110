...
<c:if test="${!empty kclist }">
	<div style="height:80px; color: #03A9F3;padding-left:30px;margin-bottom: 60px;background-color:#F8F8F8;padding:26px 0 0px 60px; "><h3 style="font-size: 24px;color: #5CB6F6">外来方培训学习课程</h3></div>
</c:if>
