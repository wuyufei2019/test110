...
<script type="text/javascript" src="${ctx}/static/model/js/aqpx/wlfpx/ksjl/index.js?v=1.3"></script>
...
<div class="easyui-tabs" fit="true">
		<div title="考试记录" style="height:100%;" data-options="">
        	...
        	<form id="aqpx_pxjl_searchFrom" style="margin-bottom: 8px;" action="" class="form-inline">
				...
				<span  class="btn btn-primary btn-rounded btn-outline btn-sm " onclick="openerm()" ><i class="fa fa-search-plus"></i> 二维码考试</span>
			</form>
			</div>
