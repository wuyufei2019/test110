...
<body>
     ...
     <form id="inputForm" action="${ctx}/aqpx/wlfpx/pxjl/${action}"  method="post" class="form-horizontal" >
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
			  	<tr>
					<td class="width-15 active"><label class="pull-right">培训类别：</label></td>
					<td class="width-85" colspan="3">
					<input id="M1_4" name="M1_4" type="text" class="easyui-combobox"  value="${pxjl.m1_4 }" style="width: 100%;height: 30px;" data-options="required:'true',editable: false,panelHeight:'150',data:[
										{value: '访客', text: '访客'},
				...
				<tr>
					...
					<td class="width-35" colspan="3"><input name="M1" style="width: 100%;height: 30px;" class="easyui-textbox"
								value="${pxjl.m1 }" data-options="required:'true'"  /></td>
				</tr>

				<tr>
					<td class="width-15 active"><label class="pull-right">姓名：</label></td>
					<td class="width-35"><input name="M1_1" class="easyui-textbox" value="${pxjl.m1_1 }" style="width: 100%;height: 30px;"
								data-options=""/></td>
					<td class="width-15 active"><label class="pull-right">身份证号：</label></td>
					<td class="width-35"><input name="M1_2" class="easyui-textbox"
								value="${pxjl.m1_2 }" style="width: 100%;height: 30px;" data-options="validType:'idCode'" /></td>
				</tr>

				<tr>
					<td class="width-15 active"><label class="pull-right">工作岗位：</label></td>
					<td class="width-35"><input name="M1_3" class="easyui-textbox" value="${pxjl.m1_3 }" style="width: 100%;height: 30px;"
								data-options=""/></td>
				...
				<tr>
					...
					<td class="width-35"><input name="M5" class="easyui-textbox"
								value="${pxjl.m5 }" style="width: 100%;height: 30px;" data-options="" /></td>
				</tr>
