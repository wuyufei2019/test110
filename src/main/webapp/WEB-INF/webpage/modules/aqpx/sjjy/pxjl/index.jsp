...
$(function(){
    ...
    columns:[[    
              ...
              {field:'operation',title:'三级安全教育卡',sortable:false,width:30,align:'center',
            	  formatter : function(value,row){
                  	return  "<a class='btn btn-info btn-xs' onclick='exportcard("+row.id+")'>导出</a>";
            	  }},
    ]],
...
function fileexport(){
	...
	url=ctx+"/aqpx/sjjy/pxjl/export?param="+param;
...
function exportcard(id) {
	$.ajax({
		url : ctx + "/aqpx/sjjy/exportcard/" + id,
		type : "POST",
		success : function(data) {
