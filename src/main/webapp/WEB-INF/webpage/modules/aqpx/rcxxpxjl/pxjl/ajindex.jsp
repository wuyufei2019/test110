...
<div id="aqpx_pxjl_tb" style="padding:5px;height:auto">
	...
	<div class="form-group">
		<input type="text" id="aqpx_rcxxpxjl_qyname" name="aqpx_rcxxpxjl_qyname" class="easyui-combobox"  style="height: 30px;" data-options="editable:true ,valueField: 'text',textField: 'text',url:'${ctx}/bis/qyjbxx/idjson',prompt: '企业名称' "/>
		<input type="text" id="aqpx_rcxxpxjl_name" name="aqpx_rcxxpxjl_name" class="easyui-textbox" style="height: 30px;" data-options="prompt: '外来方名'" />		        	        
...
function fileexport(){
	...
	url=ctx+"/aqpx/rcxxpxjl/pxjl/export2?param="+param;
