...
<body>
   ...
   <form id="inputForm" action="${ctx}/target/mbzp/${action}" method="post" class="form-horizontal">
      <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
         <tbody>
            <tr>
               <td class="width-15 active"><label class="pull-right">安全指标：</label></td>
               <td class="width-35" ><input id="id2" name="ID2" value="${target.ID2 }" class="easyui-combobox"style="width: 100%;height: 30px;"
