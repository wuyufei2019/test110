...
<div class="shadow">
	<div style="padding: 30px 35px;">
	  	<div  class="fltitle" >${entity.m1 }</div>
	  	<div  class="intro" >发布时间: <fmt:formatDate value="${entity.s1 }" pattern="yyyy-MM-dd HH:mm:ss"/></div>
	  	<hr />
		<br />
	  	<div >
	  	<p style="line-height:20px;">${entity.m2 }</p>
		  	<br />
		  	<hr />
		  	备注:${entity.m4 }
		  	<hr />
		  	附件下载：
			<div >
				 <c:if test="${not empty entity.m3}">
				 <div id="art_addFormFj" style="width:100%;float: left;">
				 <c:forTokens items="${entity.m3}" delims="," var="url" varStatus="urls">
