...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/targetmanger/fytq/ajindex.js?v=1.2"></script>
...
<div id="aqsc_fytq_tb" style="padding:5px;height:auto">
	...
	<div class="form-group">
		<input type="text" id="aqsc_fytq_qyname" name="aqsc_fytq_qyname" class="easyui-combobox"  style="height: 30px;" data-options="editable:true ,valueField: 'text',textField: 'text',url:'${ctx}/bis/qyjbxx/idjson',prompt: '企业名称' "/>
