     ...
     <form id="inputForm" action="${ctx}/zdgl/aqps/${action}"  method="post" class="form-horizontal" >
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">选择规程：</label></td>
					<td class="width-35" colspan="3">
						<input value="${aqps.m1 }" id="M1" name="M1" style="width: 100%;height: 30px;"
								class="easyui-combobox"
								data-options="required:'true',multiple:true,valueField: 'id',textField: 'text',url:'${ctx}/zdgl/aqps/gcidjson'" />
					</td>
				</tr>
				</c:if>
			 	<tr >
