...
<html>
<head>
    <title>安全操作规程修订记录</title>
    <meta name="decorator" content="default"/>
</head>
<body >
<div id="zdgl_czgc_tb_his" style="padding:5px;height:auto">
...
<table id="zdgl_czgc_dg_his"></table>
<script type="text/javascript">
    var id2 = '${id2}';
    var dg;
    $(function(){
        dg=$('#zdgl_czgc_dg_his').datagrid({
            method: "post",
            url:ctx+'/zdgl/czgc/hislist?id2='+id2,
            fit : true,
            fitColumns : true,
            border : false,
            idField : 'id',
    ...
    function view(){
        ...
        openDialogView("查看安全管理制度信息",ctx+"/zdgl/czgc/hisview/"+row.id,"800px", "400px","");
    }
</script>
</body>
</html>