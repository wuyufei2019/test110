...
<div class="wpbox">
    ...
    <div class="left1" style="width: 33%;">
        <div class="amiddboxttop" style="height: 50%;">
            <h2 class="tith2 pt2" style="padding-top: 2.5%;">储罐实时监控</h2>
                ...
                <div class="item-ctt">
                    <div class="cg_1" style="width: 100%;display: flex;justify-content: space-around;align-items: center">
        ...
        <div class="arightboxtop" style="height: 50%;position: relative;">
            ...
            <div class="item-ctt" style="height: 87%;">
    ...
    <div class="mrbox_topmidd" style="width: 33.6%;margin-left:0.4%">
        <div class="amiddboxttop" style="height: 50%;">
            ...
            <div class="tab_ctt">
                <div id="cqmnt_ctt" style="margin-left: 2.5%; margin-top: 1%;height: 87%;width: 95%;">
                    <div class="item-ctt">
                                            ...
                                            <c:if test="${ status.index %4 == 0}">
                                                <li data-color="#1abc9c">
                                                    <div class="item_block" style="width: 100%!important;">
                                                        ...
                                                        <div class="qt_item v_btn_">
                                                            <div class="qtinfor">
                                                                <div class="qt_item_img"></div>
                                                                <div class="qt_item_text">
                                                                    <div>气体&nbsp;&nbsp;<span style="background: #FFC107;">${ss.target_name}</span>
                                                                    </div>
                                                                    <div>浓度&nbsp;&nbsp;<span>${ss.value}<c:if test="${ss.target_type eq 'YDQT'}">mg/m³或ppm</c:if><c:if test="${ss.target_type eq 'KRQT'}">%LEL</c:if></span></div>
                                                                    <div>类型&nbsp;&nbsp;<span><c:if test="${ss.target_type eq 'YDQT'}">有毒气体</c:if><c:if test="${ss.target_type eq 'KRQT'}">可燃气体</c:if></span></div>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <c:if test="${qtsjlbList != null and fn:length(qtsjlbList) > 0}">
                            <c:forEach items="${qtsjlbList}" var="s">
                                <div id="fxdxq_" class="list_li">
                                    ...
                                    <div class="w25"><fmt:formatDate value="${s.cjsj}" pattern="yyyy-MM-dd HH:mm:ss"/></div>
                                    <div class="w15">
        ...
        <div class="amidd_bott" style="height: 50%;">
            <div class="amiddboxtbott1 fl">
                ...
                <div id="edminfo" class="labic_"
                     style="margin: 15px;margin: 15px;overflow-y: scroll; height: 82%;text-align: center;">
                </div>
            </div>
        </div>
    ...
    <div class="mrbox_top_right" style="width: 32.6%;">
                                                    ...
                                                    <div class="item_block">
                                                        ...
                                                        <div class="qt_item v_btn_" style="height: 100%">
                                                            <div class="qtinfor">
                                                                ...
                                                                <div class="qt_item_text">
                                                                    <div>名称&nbsp;&nbsp;<span style="background: #FFC107;">${ss.gwgyname}</span></div>
                                                                    <div>温度&nbsp;&nbsp;<span>${ss.wd}℃</span></div>
                                                                    <div>压力&nbsp;&nbsp;<span>${ss.yl}kPa</span></div>
                                                                    <div>液位&nbsp;&nbsp;<span>${ss.yw}m</span></div>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <c:if test="${gwgylbList != null and fn:length(gwgylbList) > 0}">
                            <c:forEach items="${gwgylbList}" var="s">
                                <div id="fxdxq_" class="list_li">
                                    ...
                                    <div class="w20"><fmt:formatDate value="${now}" pattern="yyyy-MM-dd HH:mm:ss"/></div>
                                </div>
                            </c:forEach>
                        </c:if>
                    </div>
        ...
        <div class="arightboxtop" style="height: 50%;">
            ...
            <div class="labic_" style="margin: 15px;height: 82%;overflow-y: scroll;">
...
//pagination
                ...
                success: function (data) {
                    ...
                    if (parseData != null && parseData != '' && parseData != undefined) {
                        $.each(parseData, function (index, el) {
                            ...
                            html += '           <span class="rsn f2">位号：'+el.wh+' 储存物质：'+el.wl+'</span>';
        ...
        function showVideo(urls, index) {
            ...
            for (var i = index; i < (index + 4); i++) {
                var videoObject = {
                    container: '#playlive' + id,//“#”代表容器的ID，“.”或“”代表容器的class
