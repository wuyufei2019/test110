...
<meta charset="utf-8">
<title>分类列表</title>
<link href="${ctxStatic}/model/vd2/css/style.css"  rel="stylesheet" type="text/css" media="all" />
<script src="${ctxStatic}/model/vd2/js/echarts.min.js" charset="utf-8"></script>
