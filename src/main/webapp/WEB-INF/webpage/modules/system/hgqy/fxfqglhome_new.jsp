...
#sxxx{
height: calc(100% - 10px);float: left;box-shadow:1px 1px 5px #ddd;overflow-y:scroll;padding: 5px;
}

div#sxxx::webkit-scrollbar{
  width:0px;
}
div#sxxx::-webkit-scrollbar-track{
  background: #fff;
  border-radius:2px;
}
div#sxxx::-webkit-scrollbar-thumb{
  background: #fff;
  border-radius:10px;
}
div#sxxx::-webkit-scrollbar-thumb:hover{
  background: #fff;
}
div#sxxx::-webkit-scrollbar-corner{
  background: #fff;
}
</style>
</head>
<body>
	<div class="container-fluid bggrey" style="overflow-y: scroll;">
		<div id="mapcontent" class="col-lg-8 col-md-6 col-sm-12 col-xs-12 bs-example mgt10 " style="margin-right:5px;margin-left: -5px;box-shadow: 1px 1px 5px #ddd;height: calc(100% - 10px);">		
			<iframe width="100%" scrolling="no" height="100%" id="mainIframe" src="${ctx}/fxgk/fxfb/index" frameborder="0"></iframe>
		</div>
		<!-- -->
		<div id="mapcontent" class="col-lg-8 col-md-6 col-sm-12 col-xs-12 bs-example mgt10 "
			style="margin-right:5px;margin-left: -5px;box-shadow: 1px 1px 5px #ddd;height: calc(100% - 10px);display:none">
			<div class="lab_btn">
			</div>
		...
		<div id="sxxx" class="boxx2 col-lg-4 col-md-6 col-sm-12 col-xs-12 bs-example mgt10">
			<div id="" style="padding:5px;height:auto; background: white;">
				<a style="display:none;"><i id="rightcont" class="fa fa-angle-double-right fa-2x"
			...
			<div id="cate_" class="">
				<div id="cate_1_1">
					<div id="cate_1_ecs" class="col-lg-6 col-md-6 col-sm-6">
					...
					<div id="cate_1_r" class="col-lg-6 col-md-6 col-sm-6">
	...
	<script type="text/javascript">
		...
		// 弹出风险点辨识清单信息
		function showbsqd() {
			openDialogView("查看风险点辨识清单信息",ctx+"/fxgk/fxdbsqd/homeindex","90%", "90%","");
		}

		// 弹出风险分级管控清单信息
		function showfjgk() {
			openDialogView("查看风险分级管控清单信息",ctx+"/fxgk/fxdfjgkqd/homeindex","90%", "90%","");
		}

		// 弹出风险告知卡信息
		function showgzk() {
			openDialogView("查看风险告知卡信息",ctx+"/fxgk/fxgzk/index","90%", "90%","");
		}

		// 弹出应急处置卡信息
		function showczk() {
			openDialogView("查看应急处置卡信息",ctx+"/fxgk/yjczk/index","90%", "90%","");
		}

		// 弹出安全承诺卡信息
		function showcnk() {
			openDialogView("查看安全承诺卡信息",ctx+"/fxgk/aqcnk/index","90%", "90%","");
		}
	</script>
</body>
</html>