					...
					<div class="ctt" style="display: flex;flex-wrap: wrap;">
						...
						<div class="ctt_item" style="color: #125a9a;background: #c6dff3;cursor: pointer;" onclick="showfjgk()">
							<div class="ctt_item_img">
                                ...
                                <img width="80px" src="${ctx}/static/model/vd2/img/组2.png">
							</div>
						...
						<div class="ctt_item" style="color: #ff7800;background: #ffd89e;cursor: pointer;" onclick="showgzk()">
							<div class="ctt_item_img">
                                ...
                                <img width="80px" src="${ctx}/static/model/vd2/img/组3.png">
							</div>
						...
						<div class="ctt_item" style="color: #439446;background: #cbeaa7;cursor: pointer;" onclick="showczk()">
							<div class="ctt_item_img">
								<%--<i class="fa fa-area-chart"></i>--%>
                                    <img width="80px" src="${ctx}/static/model/vd2/img/组4.png">
							</div>
						...
						<div class="ctt_item"
							...
							<div class="ctt_item_img">
								<%--<i class="fa fa-dedent"></i>--%>
                                    <img width="80px" src="${ctx}/static/model/vd2/img/组5.png">
							</div>
	...
	<script type="text/javascript">
		...
		function showbsqd() {
			...
			top.layer.open({
				...
				title: "查看风险点辨识清单信息",
				maxmin: true,
				content: ctx+"/fxgk/fxdbsqd/index" ,
				btn: ['关闭'],
		...
		function showfjgk() {
			...
			top.layer.open({
				...
				title: "查看风险分级管控清单信息",
				maxmin: true,
				content: ctx+"/fxgk/fxdfjgkqd/index" ,
				btn: ['关闭'],
				cancel: function(index){
				}
			});
