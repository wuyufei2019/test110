...
<title><%=logotitle %>人员在岗在位管理系统</title>
</head>
...
<div id="container">
	<div id="hd">
    	<div class="hd-top">
            <h1 class="logo">
                ...
                <span class="comName"><%=logotitle %>人员在岗在位管理系统</span>
            </h1>
            ...
            <div class="user-info">
                <!-- <span class="" id="screen" onclick="openHgqyIndex()"
                   style="padding: 0px 12px;display: flex;align-items: center;background: #ffffff;color: #ed5565;cursor: pointer;
                   font-weight: 600;height: 32px!important;border-radius: 16px;float: left;margin-top: 10px;margin-right: 15px;">返回主菜单</span> -->
	...
	<div id="bd">
    	<div class="sidebar">
            ...
            <ul class="nav2">
                <li class="subnav-li" href="${ctx}/lydw/rydw/index" data-id="1"><a href="javascript:;" class="ue-clear"><i class="subnav-icon"></i><span class="subnav-text">首页</span></a></li>
            </ul>
		...
		<ul class="p1">
			<li class="s1">
				...
				<ul class="p2">
					...
					<li class="s2">
						<a onclick="systemJump(2,4310)"><span>安全风险分区</span></a>
					</li>
					<li class="s2 b6">
