...
<title><%=logotitle %>重大危险源监测预警系统</title>
</head>
...
<div id="container">
	<div id="hd">
    	<div class="hd-top">
            <h1 class="logo">
                ...
                <span class="comName"><%=logotitle %>重大危险源监测预警系统</span>
            </h1>
	...
	<div id="bd">
    	<div class="sidebar">
            ...
            <ul class="nav2">
                <li class="subnav-li" href="${ctx}/hgqyIndex/zdwxyhome" data-id="1"><a href="javascript:;" class="ue-clear"><i class="subnav-icon"></i><span class="subnav-text">首页</span></a></li>
            </ul>
