...
<head>
		...
		<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-header header">
				<div class="layui-main mag0" style="display: flex;background: rgba(21, 165, 146, 0.54);border-bottom: 1px solid #1e8a80;">
					<!--<a href="${ctx}/a/vd_com" class="logo" style="letter-spacing: 2px;font-size: 20px;font-weight: 600;" title="回到首页">重大危险源监测预警系统</a>-->
					<a id="logo_a" href="#" class="logo" style="letter-spacing: 2px;font-size: 20px;font-weight: 600;" title="点击进入平台导航">
						<div>
							<div id="p_nav_" class="p_active" onclick="showSysNav()" style="font-size: 18px;">重大危险源监测预警系统</div>
					...
					<ul class="layui-nav mobileTopLevelMenus" mobile>
						<li class="layui-nav-item" data-menu="xtsy">
							<a href="javascript:;"><i class="fa fa-bars"></i><cite>重大危险源监测预警系统</cite></a>
					...
					<ul class="layui-nav top_menu" style="flex-shrink: 0;display: flex;">
						...
						<li class="layui-nav-item" id="userInfo">
							...
							<dl class="layui-nav-child">
								<%--<dd>--%>
									<%--<a class="text" onclick="openDialog('消息查看','${ctx}/system/message/index?msgtype=dxj')"><cite>重大危险源监测预警系统</cite><span class="num" id="dxj" style="display: none">(0)</span></a>--%>
								<%--</dd>--%>
								<dd>
									<a class="text" onclick="systemJump(4,4312)"><cite>安全生产全流程管理系统</cite><span class="num" id="dsh" style="display: none">(0)</span></a>
								</dd>
								<dd>
			...
			<div class="layui-body layui-form">
				<div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
					<ul class="layui-tab-title top_tab" id="top_tabs">
						<li class="layui-this" lay-id=""><i class="layui-icon">&#xe68e;</i> <cite cap-url="hgqyIndex/zdwxyhome">首页</cite></li>
					</ul>
					...
					<div class="layui-tab-content clildFrame">
						<div class="layui-tab-item layui-show">
							<iframe src="${ctx}/hgqyIndex/zdwxyhome"></iframe>
						</div>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">
		var pid = ${pid};
		var index_path = "hgqyIndex/zdwxyhome";
	...
	layui.use(['layer'],function(){
		...
		$(".copyright-").click(function(){
	        ...
	        //layer.alert("请使用 重大危险源监测预警系统 - 企业版 进行该操作！")
	    })	
	})
