...
<html>
<head>
<title>中储粮油脂镇江基地智慧安全一体化云平台身份认证</title>
...
<body onload="openwin();" onkeydown="keyDown(event);" style="min-width: 1200px;">
    <div id="index_top_ts" style="display:none; background:#c9e9f7;">
	    <div id="index_top_nr" style=" height:30px; padding:3px 0px 0px 15px">
	    	...
	    	<a href="https://www.google.cn/chrome/" target="_blank" style="text-decoration:none;">
    ...
    <div class="logintitle" style="background: url(${ctx}/static/model/images/login/logo_zcl.jpg) left center no-repeat;">
        	中储粮油脂镇江基地智慧安全一体化云平台
            <span class="fr tel">热线电话：400-039-1179</span>
    </div>
    <div class="bgbox" id="bgbox" style="clear: both;background-image:url('${ctx}/static/model/images/login/loginbg_zjzcl.jpg');">
            ...
            <button type="submit" class="btn btn-success fr" id="loginbtn">登 录</button>
					</div>
                </form>
